...
**手で歩いた記録は `docs/WALK-0906.md`。**2026-09-06、`master` を人が触るように
一つずつ押して回った記録です。見つかった一件と、仕様かどうか決められない四件、
それに上限が実際どう効いたかが表で入っています。ここに畳まずに別の頁にしてある
のは、直したことではなく「その日そう見えた」ことだからです。
