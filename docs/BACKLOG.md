...
**単語まわりを手で歩いた記録は `docs/WALK-words.md`。**2026-09-06、`master` を
人が触るように押して回った記録です。辞書・単語シート・取り込み・読みの四つの
画面で見つかったことが、再現手順つきの表で入っています。ここに畳まずに別の頁に
してあるのは、直したことではなく「その日そう見えた」ことだからです。
