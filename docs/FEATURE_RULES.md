...
### シンプルに作る。バグが出たら、コードを継ぎ足さずに形を見直す
- Date: 2026-09-03
...
- Decision:
  ...
  **二つ、バグが出たら、その形の穴を直す。**継ぎ足さない。**新しい仕組みを足して
  古い仕組みの抜けを塞ぐのが、いちばんやってはいけないこと。**そこから先、その
  機能は二つの仕組みで動き、どちらが効いているか誰にも分からなくなる。訊く場所が
  間違っていたなら、訊く場所を直す ── 訊き直す二つ目を足すのではなく。
