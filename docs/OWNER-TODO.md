...
| 14 | Apple Ads（App Store の検索広告）を始める | まだ（2026-09-25 オーナー「apple adsやろう」。予算・国・Basic か Advanced かはオーナーが決める。Basic は 2026 年も使える、新しいアカウントに 100 ドル分のクレジットという記事あり（未確認）） |
| 15 | Product Hunt に出す（アカウント → 下書き → 公開日を予約） | まだ（2026-09-25 オーナー「プロダクト犯と行こうか」。公開日・文はオーナーが決める） |
