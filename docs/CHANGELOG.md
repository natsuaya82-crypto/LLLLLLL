...
「今日のお題だけ、毎回その人の表示言語になるようにできないの？…今日のお題だけは
全員見れるようにしたい」OWNER 2026-09-01。

お題への返答は**お題の id**（`post.pr`、鍵の付いた列）と、**書いた人のアプリが
言った言葉**を持っています。言葉が凍っているのは正しい ── 投稿に乗るものは全部
そうです。ただしこの一文だけは**その人の書いたものではなくアプリの文**で、
サーバーが十言語ぶん持っています。日本語の人の返答が英語の人の画面でも日本語
だったのは、そこだけの話でした。

`postSay()` が、お題の id を持つ投稿だけ `dayMap()` に訊きます。**今日のぶん
だけ**です（`DAY` は一行しか無いので）。それより古いものは今までどおり投稿が
運んでいる言葉。**保存の仕方は一つも変えていません。**

`post-check` に四つ ── 英語の画面で英語、日本語の画面で日本語、お題でない投稿は
書いた人の言葉のまま、この端末が持っていないお題は投稿の言葉に落ちる。
