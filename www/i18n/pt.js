...
defLang('pt', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "plan.pro.1"      : "Adicionar letras, nomeá-las, apagá-las",
      "plan.pro.2"      : "Um silabário, um abjad, um abugida ou uma logografia",
      "plan.pro.3"      : "Até três teclados montados por você",
      "plan.price.free"  : "$0",
      "plan.pro.6"  : "Escolher os sons, as etapas de gramática e a direção da escrita",
      "plan.pro.5"  : "Trazer uma lista como arquivo e levar uma embora",
      "plan.pro.4"  : "Palavras sem limite",
      "plan.each.pro"  : "$8.33",
