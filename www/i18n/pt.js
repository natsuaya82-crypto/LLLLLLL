...
defLang('pt', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "wld.ask"      : "Para que serve?",
      "wld.use"      : "Para que serve",
      "wld.story"    : "Uma história",
      "wld.story.d"  : "Alguém de um livro, um filme, um jogo fala.",
      "wld.people"   : "Um povo",
      "wld.people.d" : "Um povo que não está nesta terra, ou que esteve.",
      "wld.place"    : "Um lugar",
      "wld.place.d"  : "Um vale, uma ilha, uma cidade, e como se fala lá.",
      "wld.real"     : "Para falar",
      "wld.real.d"   : "Feita para usar de verdade, com alguém ou sozinho.",
      "wld.play"     : "Para descobrir",
      "wld.play.d"   : "Feita para ver o que acontece se uma língua funciona assim.",
      "wld.where"    : "Onde se fala",
      "wld.where.ph" : "os vales do norte",
      "wld.who"      : "Quem fala",
      "wld.who.ph"   : "o povo do rio",
      "wld.note"     : "Sobre este mundo",
      ...
      "stg.noun.d"       : "Mais de um, e as formas que um substantivo toma.",
      "stg.verb.t"       : "Verbos",
      "stg.verb.d"       : "O tempo, e no que um verbo vira quando muda.",
      "stg.neg.not"      : "não",
      "stg.ask.why"      : "por que",
      "stg.ask.how"      : "como",
      "stg.conj.t"       : "Ligar",
      "stg.conj.d"       : "e, ou, mas — e as palavras que penduram uma oração na outra.",
      "stg.conj.and"     : "e",
      "stg.conj.or"      : "ou",
      "stg.conj.but"     : "mas",
      ...
      "stg.part.d"       : "Palavras pequenas que marcam o que uma palavra faz na frase.",
      "stg.polite.t"     : "Cortesia",
      "stg.polite.d"     : "Como a língua muda quando fala com cuidado.",
      "stg.where.t"      : "Lugar",
      "stg.where.in"     : "em",
      "stg.where.on"     : "sobre",
      "stg.where.under"  : "sob",
      ...
      "stg.where.from"   : "de",
      "stg.where.with"   : "com",
      "stg.where.d"      : "Onde uma coisa está e para onde vai.",
      "stg.when.t"       : "Tempo",
      "stg.when.now"     : "agora",
      ...
      "stg.when.d"       : "Quando uma coisa acontece.",
      "stg.decide"       : "Decidir",
      ...
      "word.note"        : "Nota",
      "word.sp"          : "Esta letra aqui",
      "word.sp.none"     : "Aperte as letras",
      "word.sp.del"      : "Tirar esta letra",
