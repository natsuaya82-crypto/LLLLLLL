...
defLang('pt', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "set.wipe"         : "Apagar os dados deste telemóvel",
      "set.drop"         : "Eliminar conta",
      "set.drop.done"    : "Conta eliminada",
      "confirm.drop"     : "Eliminar a sua conta? As suas publicações, fotografias e gravações saem do servidor e não podem ser recuperadas. A língua neste telemóvel fica onde está.",
