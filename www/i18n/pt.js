...
defLang('pt', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "kb.kb.add"               : "Adicionar um teclado",
      "kb.kb.del"               : "Excluir este teclado",
      "kb.del.ask"               : "Excluir este teclado definitivamente? Os outros não serão afetados.",
      "kb.del.done"               : "Teclado excluído",
      ...
      "sns.lock.h"      : "Entre para ver a linha do tempo",
      "sns.lock.cta"    : "Entrar",
      "tab.find"         : "Buscar",
      "tab.home"         : "Início",
