...
defLang('pt', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "kb.step1" : "Adicionar o Lingua como teclado",
      "kb.step1.d" : "Ajustes → Geral → Teclado → Teclados → Adicionar teclado → Lingua",
      "kb.step2" : "Nos ajustes do Lingua, toque em Teclados",
      "kb.step3" : "Ative Permitir acesso total",
