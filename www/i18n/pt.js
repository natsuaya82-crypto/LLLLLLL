...
defLang('pt', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "confirm.wipe.langs": "Excluir {0}? Tudo o que foi criado nele desaparece: as palavras, as letras, o sistema de escrita, o teclado, as notas e os sons. O arquivo de backup também. Ele é removido da sua conta, portanto não voltará em outro telefone. Seus outros idiomas, suas publicações e sua conta permanecem. Isto não pode ser desfeito.",
      "langs.title"      : "Idiomas",
