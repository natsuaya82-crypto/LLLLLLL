...
defLang('pt', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "find.ph"          : "Buscar nesta língua",
      "find.mine.h"      : "Tudo o que você fez",
      "find.mine.d"      : "Grafia, significado ou leitura — de qualquer parte da língua.",
      "find.world.h"     : "As línguas de outras pessoas",
      "find.world.d"     : "Ainda não está aberto. Quando estiver, ficará aqui.",
      "toc.sound"        : "Fonologia",
      "toc.letters"      : "Letras",
      "ab.title"         : "A bancada das vogais",
      "ab.d"             : "Numa abugida uma letra é uma consoante com uma marca de vogal em cima, então o que precisa ficar certo não é um desenho e sim como a marca assenta em cada consoante. Mude a marca aqui e todas mudam juntas.",
      "ab.mark"          : "A marca de {0}",
      "ab.every"         : "Todas as consoantes com {0}",
      "ab.cell"          : "Toque numa para desenhar essa combinação sozinha, quando a marca não ficar bem nela.",
      ...
      "ab.nomark"        : "Esta vogal ainda não tem marca desenhada.",
      "ab.nocons"        : "Ainda não há consoantes.",
      "ab.novow"         : "Ainda não há vogais.",
      "ab.notabugida"    : "Esta língua não se escreve como abugida.",
      "lt.note"          : "Uma letra e um som não são a mesma coisa. Um som pode ser escrito de duas maneiras, uma letra pode ser lida de duas maneiras, e uma letra pode existir antes de você decidir o que ela diz.",
      "lt.all"           : "Todas as letras",
      "lt.none"          : "Ainda não há letras.",
      "lt.new"           : "Uma letra nova",
      "lt.untitled"      : "Sem nome",
      "lt.draw"          : "Desenhar uma letra",
      "lt.use"           : "Usar uma letra que já existe",
      "lt.use.d"         : "Que letras escrevem {0}. Um som pode ter mais de uma.",
      "lt.addsnd"        : "O que lê",
      "lt.addsnd.d"      : "Dê um nome a esta letra e diga que sons ela lê. Pode não ler nenhum, ou vários.",
      "lt.reads"         : "lê {0}",
      "lt.reads.none"    : "ainda não lê nada",
      "lt.reads.h"       : "Sons que esta letra lê",
      "lt.name"          : "Nome",
      "lt.name.ph"       : "p. ex. esh",
      ...
      "as.soft"         : "Suave",
      "as.soft.d"       : "Nasais, l e r, vogais limpas. Como o japonês ou o italiano.",
      "as.hard"         : "Duro",
      "as.hard.d"       : "Oclusivas e chiados, poucas vogais. Como o georgiano ou o náuatle.",
      "as.flowing"      : "Fluido",
      "as.flowing.d"    : "Sons sonoros, cinco vogais, quase nada de agudo.",
      "as.breathy"      : "Aspirado",
      "as.breathy.d"    : "Fricativas e h. Como o árabe ou o galês.",
      "as.plain"        : "Simples",
      "as.plain.d"      : "Um conjunto pequeno, fácil de dizer. Como o havaiano.",
      "as.hear"         : "Ouvir todos",
      "as.again"        : "Outro conjunto",
      "as.own"          : "Escolher eu mesmo",
      "as.drop"         : "Tirar este som",
      "as.more.c"       : "Mais uma consoante",
      "as.more.v"       : "Mais uma vogal",
      "as.more.none"    : "Não há mais sons para acrescentar.",
      /* the grammar, in stages */
      "stg.list.d"       : "Uma gramática se constrói por etapas. Cada uma guarda as palavras de que precisa, as decisões que carrega e uma frase que você pode dizer quando ela termina.",
      ...
      "stg.line"         : "O que você já pode dizer",
      "stg.make"         : "criar",
      "stg.make.d"       : "Toque nos sons, ou pegue uma das sugestões.",
      "stg.keep"         : "Guardar esta palavra",
      "stg.drop"         : "Apagar esta palavra",
      "stg.help"         : "Sugerir uma palavra",
      "stg.help.d"       : "Feita com os sons que esta língua tem.",
      "stg.again"        : "Outras",
      "stg.own.add.btn"  : "Adicionar uma etapa sua",
      "stg.own.hint"     : "Tratamento, parentesco, direção — o que esta língua acabar precisando. Não há limite.",
      "stg.own.h"        : "Uma etapa sua",
      "stg.own.d"        : "Dê um nome e liste as palavras de que ela precisa — uma por linha.",
      "stg.own.title"    : "Nome da etapa",
      ...
      "stg.own.add"      : "Adicionar",
      "stg.own.need"     : "Dê um nome à etapa.",
      "stg.own.added"    : "{0} adicionada",
      "stg.own.untitled" : "Etapa sem nome",
      "stg.own.del"      : "Apagar esta etapa",
      "stg.own.del.ask"  : "Apagar esta etapa? As palavras dela continuam no dicionário.",
      /* the stages */
      "stg.greet.t"      : "Sim, não, olá",
      "stg.greet.d"      : "As coisas mais curtas que dá para dizer. Uma palavra cada, e a língua já pode ser falada.",
      "stg.greet.yes"    : "sim",
      "stg.greet.no"     : "não",
      "stg.greet.hello"  : "olá",
      "stg.greet.bye"    : "adeus",
      ...
      "stg.pron.d"       : "Sem eles não há sujeito, então a ordem das palavras ainda não tem o que ordenar.",
      "stg.pron.i"       : "eu",
      "stg.pron.you"     : "você",
      "stg.pron.he"      : "ele / ela",
      "stg.pron.we"      : "nós",
      ...
      "stg.order.d"      : "Agora que há sujeito, decida onde ele fica.",
      ...
      "stg.neg.t"        : "Dizer não",
      "stg.neg.d"        : "Como a língua diz o contrário do que foi dito.",
      "stg.ask.t"        : "Perguntar",
      "stg.ask.d"        : "A marca que transforma algo dito em pergunta, e as palavras que perguntam por uma coisa determinada.",
      "stg.ask.what"     : "o que",
      "stg.ask.who"      : "quem",
      "stg.ask.where"    : "onde",
      "stg.ask.when"     : "quando",
      "stg.desc.t"       : "Descrever",
      "stg.desc.d"       : "Onde fica a palavra que descreve.",
      "stg.have.t"       : "Pertencer",
      "stg.have.d"       : "Como a língua diz que uma coisa é de outra.",
      "stg.count.t"      : "Contar",
      "stg.count.d"      : "De um a dez. A maioria das línguas constrói o resto a partir deles.",
      ...
      "words.open"       : "Abrir esta palavra",
      "words.sayall"     : "Ouvir todas",
      "words.stop"       : "Parar",
      ...
      "word.uses"        : "Usada em",
      "word.uses.none"   : "Esta palavra ainda não aparece em nenhuma frase.",
      "word.note"        : "Nota",
      "word.note.d"      : "O que quiser lembrar desta palavra: de onde veio, com o que não deve ser confundida.",
      ...
      "word.syn.d"       : "Que palavras querem dizer o mesmo que {0}. Escolher uma faz o par, nos dois sentidos.",
      ...
      "word.ant.d"       : "Que palavras querem dizer o contrário de {0}. Escolher uma faz o par, nos dois sentidos.",
      "word.ex"          : "Exemplos",
      "word.ex.d"        : "Uma frase nesta língua e o que ela quer dizer. Escreva a frase com as palavras separadas por espaços; as que já estão no dicionário podem ser ouvidas.",
      "word.ex.ln.ph"    : "palavras separadas por espaços",
      "word.ex.gl.ph"    : "o que quer dizer",
      "word.ex.del"      : "Apagar este exemplo",
