...
defLang('pt', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.sns.1.n" : "Mara",
      "ob.sns.1.h" : "mara",
      "ob.sns.1.l" : "Terminei o alfabeto hoje. Vinte e oito letras.",
      "ob.sns.2.n" : "Tomás",
      "ob.sns.2.h" : "tomas",
      "ob.sns.2.l" : "Criei uma palavra para o cheiro de chuva.",
      "ob.sns.3.n" : "Inês",
      "ob.sns.3.h" : "ines",
      "ob.sns.3.l" : "Três meses e já escrevo uma frase inteira.",
      "ob.sns.4.n" : "Kai",
      "ob.sns.4.h" : "kai",
      "ob.sns.4.l" : "Meu teclado já funciona no celular.",
      "ob.sns.5.n" : "Noor",
      "ob.sns.5.h" : "noor",
      "ob.sns.5.l" : "Sistema de contagem pronto. Base doze.",
      "ob.sns.6.n" : "Elias",
      "ob.sns.6.h" : "elias",
      "ob.sns.6.l" : "Seiscentas palavras. Já soa como língua.",
      "ob.tour.row.letters" : "Toque em Letras.",
      "ob.tour.row.words" : "Toque em Léxico.",
      "ob.tour.row.gram" : "Toque em Gramática.",
      "ob.tour.letters" : "Suas letras.",
      "ob.tour.words" : "Suas palavras.",
