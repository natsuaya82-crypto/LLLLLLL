...
defLang('pt', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "snd.empty" : "Ainda não há sons",
      "snd.nolt" : "nenhuma letra o diz",
      ...
      "fmr.what"         : "Escreva uma vez como uma forma é feita e qualquer palavra poderá dar as formas que ainda não tem. Nada é criado até você pedir, e o que sai é uma palavra comum: edite, apague, ou escreva você mesmo uma irregular.",
      "fmr.new"          : "Escrever uma regra",
      "fmr.any"          : "Qualquer palavra",
      "fmr.pos"          : "Palavras a que se aplica",
      "fmr.fm"           : "Forma que faz",
      ...
      "set.wipe"         : "Eliminar conta",
      "confirm.wipe"     : "Apagar tudo neste telemóvel e sair? A língua, as letras e as definições desaparecem, e não dá para desfazer.",
      "langs.title"      : "Idiomas",
      ...
      "plan.plus.2"      : "Um silabário, um abjad, um abugida ou uma logografia",
      "plan.plus.3"      : "Até três teclados montados por você",
      "plan.studio.1"    : "Tudo do Plus",
      "plan.studio.2"    : "Trabalhar com uma IA: palavra a partir de um significado, gramática, exemplos",
      "plan.studio.3"    : "Sugestões sem limite diário",
      "plan.price.free"  : "$0",
      "plan.plus.6"  : "Escolher os sons, as etapas de gramática e a direção da escrita",
      "plan.plus.5"  : "Trazer uma lista como arquivo e levar uma embora",
      "plan.plus.4"  : "Palavras sem limite",
      "plan.each.studio"  : "$16.67",
      "plan.each.plus"  : "$8.33",
      "plan.price.studio.yr"  : "$199.99",
      "plan.price.plus.yr"  : "$99.99",
      "plan.each"  : "{0} por mês, cobrado uma vez por ano",
      "plan.per.yr"  : "/ ano",
      "plan.per.mo"  : "/ mês",
      "plan.save"  : "2 meses grátis",
      "plan.term.yr"  : "Anual",
      "plan.term.mo"  : "Mensal",
