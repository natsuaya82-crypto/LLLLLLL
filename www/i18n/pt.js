...
defLang('pt', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ask.full"     : "Longo demais para enviar",
      ...
      "ask.word.ask" : "Proponha 8 palavras novas que combinem com esta língua. Use apenas os sons acima e as formas de palavra que ela já tem. Para cada uma, dê a palavra, um significado, a leitura em AFI e uma linha sobre por que essa forma.",
      "words.more" : "Mais",
      ...
      "wr.s3"            : "Imprimi-la e escrever",
      "wr.s3.d"          : "Uma letra por casa.",
      "wr.s4"            : "Digitalizar e instalar",
      "wr.s4.d"          : "Devolver aqui a digitalização como PDF.",
      "wr.names"         : "Nomes",
      "wr.ph"            : "7, 2, 25",
      "wr.boxes"         : "{0} quadros",
      "wr.boxes.1"       : "1 quadro",
      ...
      "wr.in"            : "Escolher um PDF digitalizado",
