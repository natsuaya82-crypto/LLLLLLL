...
defLang('pt', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "word.note"        : "{0} sílabas. Acima está a própria palavra, nos sons que você escolheu.<br>Ao lado de cada sílaba está a pronúncia figurada para quem fala {1} ({2}); o botão a diz em voz alta.",
      "word.note.1"      : "Uma sílaba. Acima está a própria palavra, nos sons que você escolheu.<br>Ao lado está a pronúncia figurada para quem fala {1} ({2}); o botão a diz em voz alta.",
      "word.edit"        : "Alterar",
