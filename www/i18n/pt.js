...
defLang('pt', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.sns.2.m" : "Criei uma palavra para o cheiro de chuva.",
      "ob.sns.3.n" : "Sela",
      "ob.sns.3.h" : "sela",
      "ob.sns.3.l" : "arun teva mi kastel, ova neri sa.",
      "ob.sns.3.m" : "Três meses e já escrevo uma frase inteira.",
      "ob.sns.4.n" : "Kai",
      "ob.sns.4.h" : "kai",
      "ob.sns.4.l" : "mel korva anta ve losin.",
      "ob.sns.4.m" : "Meu teclado já funciona no celular.",
      "ob.sns.5.n" : "Nuri",
      "ob.sns.5.h" : "nuri",
      "ob.sns.5.l" : "tavel esko rin, ilma korsa te.",
      "ob.sns.5.m" : "Sistema de contagem pronto. Base doze.",
      "ob.sns.6.n" : "Erim",
      "ob.sns.6.h" : "erim",
      "ob.sns.6.l" : "vasta lome ker un sadi, terin ova.",
      "ob.sns.6.m" : "Seiscentas palavras. Já soa como língua.",
      "ob.tour.row.letters" : "Toque em Letras.",
      "ob.tour.row.gram" : "Toque em Gramática.",
      "ob.tour.letters" : "Suas letras.",
      "ob.tour.gram" : "Sua gramática.",
