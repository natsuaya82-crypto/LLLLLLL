...
defLang('pt', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "kb.up.d" : "Faça upgrade e o teclado pode ter a forma que você quiser.",
      ...
      "ask.f.snd"    : "Sons (AFI)",
      "ask.f.lts"    : "Letras",
      "ask.f.order"  : "Ordem das palavras",
      "ask.f.syl"    : "Sílabas",
      "ask.f.syl.v"  : "{0} em {1} de {2} palavras",
      "ask.f.end"    : "Final de palavra",
      ...
      "words.sel.all"    : "Selecionar tudo",
      "words.sel.none"   : "Desmarcar tudo",
