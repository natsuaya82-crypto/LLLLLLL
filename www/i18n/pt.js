...
defLang('pt', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "mod.down"           : "Remover esta publicação",
      "mod.up"             : "Restaurar",
      "mod.out"            : "Parar @{0}",
      "mod.in"             : "Restaurar @{0}",
      "mod.out.sure"       : "Parar esta conta? Fica tudo como está e ainda pode ler, mas não poderá publicar, responder nem reagir até desfazeres.",
      "post.out"           : "A tua conta foi parada. Podes ler, mas nada do que escreveres será publicado.",
      "post.down"          : "Esta publicação foi removida. Mais ninguém a vê.",
