...
defLang('pt', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "wr.out.ok"        : "Guardada",
      "wr.say.build"     : "Folha criada — {0} bytes",
      "wr.say.build.no"  : "Folha não criada — os nomes não cabem na faixa",
      "wr.say.b64"       : "Codificada — {0} caracteres",
      "wr.say.b64.no"    : "A codificação falhou — {0}",
      "wr.say.nobridge"  : "Não há onde guardá-la",
      "wr.say.sent"      : "Entregue ao telefone",
      "wr.say.filed"     : "Guardada como {0}",
      "wr.say.have"      : "Em Sheets — {0} ficheiros, o mais recente {1}",
      "wr.say.have.none" : "Em Sheets — não há nada",
      "wr.say.have.no"   : "Não foi possível ver Sheets — {0}",
      "wr.say.unnamed"   : "O telefone respondeu sem nome de ficheiro",
      "wr.say.refused"   : "O telefone recusou — {0}",
      "wr.say.got"       : "Ficheiro — {0} bytes",
      "wr.say.kind"      : "Conteúdo — {0}",
      "wr.say.jpeg"      : "Fotografia dentro — {0} bytes",
      "wr.say.jpeg.no"   : "Não há fotografia dentro",
      "wr.say.draw"      : "Pediu-se ao telefone para desenhar a página",
      "wr.say.drew"      : "O telefone desenhou-a — {0} caracteres",
      "wr.say.drew.no"   : "O telefone não desenhou nada",
      "wr.say.read"      : "Lido — {0} nomes, {1} com tinta",
