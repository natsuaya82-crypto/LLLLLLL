...
defLang('en', (function(){
  ...
  return {
    ...
    str    : {
      ...
      'wr.out.ok'         : 'Saved',
      'wr.say.build'      : 'Sheet built — {0} bytes',
      'wr.say.build.no'   : 'Sheet not built — the names will not fit the strip',
      'wr.say.b64'        : 'Encoded — {0} characters',
      'wr.say.b64.no'     : 'Encoding threw — {0}',
      'wr.say.nobridge'   : 'No file store to hand it to',
      'wr.say.sent'       : 'Handed to the phone',
      'wr.say.filed'      : 'Filed as {0}',
      'wr.say.have'       : 'In Sheets — {0} files, newest {1}',
      'wr.say.have.none'  : 'In Sheets — nothing there',
      'wr.say.have.no'    : 'Could not look in Sheets — {0}',
      'wr.say.unnamed'    : 'The phone answered and named no file',
      'wr.say.refused'    : 'The phone refused — {0}',
      'wr.say.got'        : 'File — {0} bytes',
      'wr.say.kind'       : 'What is inside — {0}',
      'wr.say.jpeg'       : 'Photograph inside — {0} bytes',
      'wr.say.jpeg.no'    : 'No photograph inside',
      'wr.say.draw'       : 'Asked the phone to draw the page',
      'wr.say.drew'       : 'The phone drew it — {0} characters',
      'wr.say.drew.no'    : 'The phone drew nothing',
      'wr.say.read'       : 'Read — {0} names, {1} with ink',
