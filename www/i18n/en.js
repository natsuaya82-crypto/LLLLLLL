...
defLang('en', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.sns.2.m" : "Made a word for the smell after rain.",
      "ob.sns.3.n" : "Sela",
      "ob.sns.3.h" : "sela",
      "ob.sns.3.l" : "arun teva mi kastel, ova neri sa.",
      "ob.sns.3.m" : "Three months in and I can write a whole sentence.",
      "ob.sns.4.n" : "Kai",
      "ob.sns.4.h" : "kai",
      "ob.sns.4.l" : "mel korva anta ve losin.",
      "ob.sns.4.m" : "My keyboard works on my phone now.",
      "ob.sns.5.n" : "Nuri",
      "ob.sns.5.h" : "nuri",
      "ob.sns.5.l" : "tavel esko rin, ilma korsa te.",
      "ob.sns.5.m" : "Counting system done. Base twelve.",
      "ob.sns.6.n" : "Erim",
      "ob.sns.6.h" : "erim",
      "ob.sns.6.l" : "vasta lome ker un sadi, terin ova.",
      "ob.sns.6.m" : "Six hundred words. It sounds like a language.",
      "ob.tour.row.letters" : "Tap Letters.",
      "ob.tour.row.gram" : "Tap Grammar.",
      "ob.tour.letters" : "Your letters.",
      "ob.tour.gram" : "Your grammar.",
