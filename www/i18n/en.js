...
defLang('en', (function(){
  ...
  return {
    ...
    str    : {
      ...
      'plan.pro.1'     : "Add letters, name them, delete them",
      'plan.pro.2'     : "A syllabary, an abjad, an abugida or a logography",
      'plan.pro.3'     : "Up to three keyboards you lay out yourself",
      'plan.price.free' : "$0",
      'plan.pro.6' : "Choose the sounds, the grammar stages, and which way it is written",
      'plan.pro.5' : "Bring a list in as a file, take one out",
      'plan.pro.4' : "Words without a limit",
      'plan.each.pro' : "$8.33",
