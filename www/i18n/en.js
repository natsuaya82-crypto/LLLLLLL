...
defLang('en', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.sns.1.n" : "Mara",
      "ob.sns.1.h" : "mara",
      "ob.sns.1.l" : "Finished the alphabet today. Twenty-eight of them.",
      "ob.sns.2.n" : "Tomas",
      "ob.sns.2.h" : "tomas",
      "ob.sns.2.l" : "Made a word for the smell after rain.",
      "ob.sns.3.n" : "Ines",
      "ob.sns.3.h" : "ines",
      "ob.sns.3.l" : "Three months in and I can write a whole sentence.",
      "ob.sns.4.n" : "Kai",
      "ob.sns.4.h" : "kai",
      "ob.sns.4.l" : "My keyboard works on my phone now.",
      "ob.sns.5.n" : "Noor",
      "ob.sns.5.h" : "noor",
      "ob.sns.5.l" : "Counting system done. Base twelve, no regrets.",
      "ob.sns.6.n" : "Elias",
      "ob.sns.6.h" : "elias",
      "ob.sns.6.l" : "Six hundred words. It sounds like a language.",
      "ob.tour.row.letters" : "Tap Letters.",
      "ob.tour.row.words" : "Tap Lexicon.",
      "ob.tour.row.gram" : "Tap Grammar.",
      "ob.tour.letters" : "Your letters.",
      "ob.tour.words" : "Your words.",
