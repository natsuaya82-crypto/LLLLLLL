...
defLang('zh', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "cap.hid"                   : "已隐藏 {0}",
      "cap.lapse.h"               : "你的订阅已结束",
      "cap.lapse.d"               : "你做的东西一个都没有删除。词、字、键盘、语法、帖子，全都还在你的账号里，和原来一样。<br><br>免费版的词典最多显示 100 个词，键盘 1 个，语言 1 个。第 101 个词以后不是消失了，只是没有显示出来。<br><br>再次升级，全部原样回来。",
      "cap.lapse.ok"              : "关闭",
      "ch.clear"                  : "不配字",
      "ch.for"                    : "给「{0}」配字",
      "ob.back"                   : "返回",
      ...
      "set.pw.done"         : "密码已修改",
      "net.needpw"         : "两项都要填。",
      "confirm.wipe"     : "清除全部数据？账号以及服务器上的所有帖子、照片和录音都会删除；本机的所有语言、文字和设置也会删除，包括备份文件。无法恢复。请先取消订阅，再删除账号。",
      "confirm.wipe.langs": "删除 {0}？在其中创建的一切都会消失 —— 词语、字母、书写系统、键盘、笔记和读音。备份文件也会一并删除。它会从你的账户中移除，因此不会在其他手机上恢复。你的其他语言、帖子和账户会保留。此操作无法撤销。",
      "langs.title"      : "语言",
      "langs.mine"       : "你的语言",
      "langs.reading"    : "阅读中",
      "langs.untitled"   : "未命名",
