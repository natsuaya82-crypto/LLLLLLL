...
defLang('zh', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "hp.lt.out.d" : "右上角的分享标记。“字体”把你画的所有字做成字体文件，可在其他应用里用。SVG 把它们做成一张图，每个字一格。",
      "hp.lt.wr.d" : "在一张纸上写你的字——在手机上或纸上——再把它拿回来。步骤在它的 ? 里。",
      "hp.lt.ab.d" : "当这门语言是元音附标文字或组合书写时，顶部会多一行，打开元音放在哪里。",
      "hp.ls.p" : "一个格子就是一个字。",
      "hp.ls.1" : "打开一个字",
      "hp.ls.1.d" : "点它的格子。",
      "hp.ls.2" : "排列",
      ...
      "hp.bk.1" : "点一个元音",
      "hp.bk.1.d" : "每个元音决定它那一格怎么分。",
      "hp.bk.2" : "选择分法",
      "hp.bk.2.d" : "左右是把元音放在辅音右边，上下是放在辅音下面。",
      "hp.bk.3" : "尾音",
      "hp.bk.3.d" : "有尾辅音的音节，在格子底部多一行。",
