...
defLang('zh', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "kb.sys.no" : "设置打不开",
      "kb.rom"               : "每个键上显示字母",
      "kb.is" : "把你画的字放在 QWERTY 上。装进手机的就是这个。",
      "kb.is.free" : "这里按不了：这个画面是给你看键盘的，不是打字的地方。",
      "kb.reset"               : "重新开始",
      "kb.pat.set" : "排列",
      ...
      "ask.f.words"  : "已有的词",
      "ask.word.ask" : "我想为这门语言批量造词。接下来怎么走由你决定 —— 想问什么就问，觉得不对就说，也可以试我没想到的方向。关于格式只有一点：请把列表放在代码块里，一行一个词，词和意思之间用制表符分隔，这样我能直接粘回应用里。",
      "words.search"     : "搜索",
      "words.clear"      : "清除",
      "words.sort.a"     : "按音序",
      ...
      "confirm.wipe.langs": "清除本机数据？本机上的所有语言都会删除：单词、文字、书写系统、键盘和笔记。备份文件也会删除。录音和导出的字帖会保留。账号会保留，帖子和设置也会保留。本机上的内容无法恢复。",
      "langs.title"      : "语言",
      "langs.mine"       : "你的语言",
      "langs.reading"    : "阅读中",
      "langs.untitled"   : "未命名",
