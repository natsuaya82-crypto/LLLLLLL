...
defLang('zh', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "hp.lt.ab.d" : "当这门语言是元音附标文字时，顶部会多一行，打开元音放在哪里。",
      "hp.ls.p" : "一个格子就是一个字。",
      "hp.ls.1" : "打开一个字",
      "hp.ls.1.d" : "点它的格子。",
      "hp.ls.2" : "排列",
      ...
      "hp.bk.p" : "组合书写时，一个音节就是一格。每个字母都按画的位置和大小放置，一个音节的字母叠在一起组成。",
      "hp.bk.1" : "画在四格之一",
      "hp.bk.1.d" : "画字的方格分成四格。把辅音画在左上、元音画在右上，音节里它们就左右并排。",
      "hp.bk.2" : "韵尾",
      "hp.bk.2.d" : "画在上半部的韵尾会向下移半格：第一个到左下，第二个到右下。",
      "hp.bk.3" : "最多四个",
      "hp.bk.3.d" : "多于四个字母、或韵尾多于两个的音节不组合。",
      "hp.sp.p" : "字与字之间隔多远。",
      "hp.sp.1" : "拖动",
