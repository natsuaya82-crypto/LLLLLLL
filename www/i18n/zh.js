...
defLang('zh', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "wr.out"           : "导出用纸",
      "wr.out.ok"        : "已导出",
      "wr.say.build"     : "已生成用纸 — {0} 字节",
      "wr.say.build.no"  : "无法生成用纸 — 名称放不进条带",
      "wr.say.b64"       : "已编码 — {0} 个字符",
      "wr.say.b64.no"    : "编码失败 — {0}",
      "wr.say.nobridge"  : "没有可保存的地方",
      "wr.say.sent"      : "已交给手机",
      "wr.say.filed"     : "已保存为 {0}",
      "wr.say.have"      : "Sheets 里 — {0} 个文件，最新的是 {1}",
      "wr.say.have.none" : "Sheets 里 — 什么也没有",
      "wr.say.have.no"   : "无法查看 Sheets — {0}",
      "wr.say.unnamed"   : "手机作了回应，但没有文件名",
      "wr.say.refused"   : "手机拒绝了 — {0}",
      "wr.say.got"       : "文件 — {0} 字节",
      "wr.say.kind"      : "里面是 — {0}",
      "wr.say.jpeg"      : "里面有照片 — {0} 字节",
      "wr.say.jpeg.no"   : "里面没有照片",
      "wr.say.draw"      : "已请手机绘制页面",
      "wr.say.drew"      : "手机绘制了 — {0} 个字符",
      "wr.say.drew.no"   : "手机什么也没画",
      "wr.say.read"      : "已读取 — {0} 个名称，其中 {1} 个有墨迹",
