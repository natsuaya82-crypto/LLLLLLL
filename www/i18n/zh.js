...
defLang('zh', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "glyph.saved"       : "已保存 {0}",
      "fmr.title"        : "按规则造的形式",
      "fmr.what"         : "把某个形式怎么造写一次，之后任何词都能补上它还没有的形式。不按就不会造，造出来的是普通的词：可以改、可以删，不规则的自己写就行。",
      "fmr.new"          : "写一条规则",
      "fmr.any"          : "所有词",
      "fmr.pos"          : "适用的词",
      "fmr.fm"           : "造出的形式",
      ...
      "set.wipe"         : "删除账号",
      "confirm.wipe"     : "清除这台手机上的一切并退出登录？语言、文字和设置都会消失，无法恢复。",
      "langs.title"      : "语言",
      "langs.mine"       : "你的语言",
      "langs.reading"    : "阅读中",
      "langs.untitled"   : "未命名",
      ...
      "plan.plus.2"      : "音节文字、辅音文字、元音附标文字或语素文字",
      "plan.plus.3"      : "最多三套自己排的键盘",
      "plan.studio.1"    : "Plus 的全部",
      "plan.studio.2"    : "与 AI 一起做：由词义造词、语法、例句",
      "plan.studio.3"    : "建议没有每日上限",
      "plan.price.free"  : "$0",
      "plan.plus.6"  : "自己决定音、语法阶段和书写方向",
      "plan.plus.5"  : "用文件导入词表，也能导出",
      "plan.plus.4"  : "词数不受限制",
      "plan.each.studio"  : "$16.67",
      "plan.each.plus"  : "$8.33",
      "plan.price.studio.yr"  : "$199.99",
      "plan.price.plus.yr"  : "$99.99",
      "plan.each"  : "每月 {0}，每年结算一次",
      "plan.per.yr"  : "／年",
      "plan.per.mo"  : "／月",
      "plan.save"  : "省两个月",
      "plan.term.yr"  : "按年",
