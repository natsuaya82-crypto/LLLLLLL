...
defLang('zh', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "cap.hid"                   : "这里还有 {0} 个词，也在你的备份里",
      "cap.lapse.h"               : "你的订阅已结束",
      "cap.lapse.d"               : "Lingua 回到了免费版，所以词典只列出前 100 个词，文字也回到了字母。<b>什么都没有被删除。</b>你的每一个词、每一个字、你的键盘都还在，也都还在备份里，重新订阅就会全部回来。",
      "cap.lapse.ok"              : "我知道了",
      "ch.clear"                  : "不配字",
      "ch.for"                    : "给「{0}」配字",
      "count.script"              : "{0} / {1}",
      ...
      "kb.empty"               : "空",
      "kb.row.add"               : "添加一行",
      "kb.sys.h"               : "这个键盘会装到你的 iPhone 上",
      "kb.sys.1"               : "设置 → 通用 → 键盘 → 键盘 → 添加新键盘 → Lingua",
      "kb.sys.2"               : "设置 → 通用 → 键盘 → 键盘 → Lingua → 允许完全访问",
      "kb.sys.full"               : "没有完全访问权限，它读不到你的文字。",
      "kb.out.ok"               : "你的文字已经交出去了。",
      "kb.out.none"               : "还没有交出去过。",
      "kb.out.no"               : "没有交出去：应用连接不到键盘，再画更多文字也没用。",
      "kb.out.bad"               : "没有交出去：{0}",
      "kb.rom"               : "每个键上显示字母",
      "set.yes"               : "开",
      "set.no"               : "关",
      ...
      "plan.plus.1"      : "词数不限",
      "plan.plus.2"      : "批量导入和导出 CSV",
      "plan.plus.3"      : "Free 的全部内容",
