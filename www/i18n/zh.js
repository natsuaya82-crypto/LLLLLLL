...
defLang('zh', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.sns.1.n" : "玛拉",
      "ob.sns.1.h" : "mara",
      "ob.sns.1.l" : "今天把字母表画完了。二十八个。",
      "ob.sns.2.n" : "托马",
      "ob.sns.2.h" : "tomas",
      "ob.sns.2.l" : "造了一个词，是雨后的味道。",
      "ob.sns.3.n" : "伊内",
      "ob.sns.3.h" : "ines",
      "ob.sns.3.l" : "三个月，已经能写一整句了。",
      "ob.sns.4.n" : "凯",
      "ob.sns.4.h" : "kai",
      "ob.sns.4.l" : "键盘终于能在手机上用了。",
      "ob.sns.5.n" : "努尔",
      "ob.sns.5.h" : "noor",
      "ob.sns.5.l" : "数字系统做好了。十二进制。",
      "ob.sns.6.n" : "伊莱",
      "ob.sns.6.h" : "elias",
      "ob.sns.6.l" : "六百个词。听起来已经像语言了。",
      "ob.tour.row.letters" : "点开文字。",
      "ob.tour.row.words" : "点开词汇。",
