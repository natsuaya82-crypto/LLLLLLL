...
defLang('de', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "find.mine.d"      : "Schreibung, Bedeutung oder Lesung — von überall in der Sprache.",
      ...
      "ab.d"             : "In einer Abugida ist ein Buchstabe ein Konsonant mit einem Vokalzeichen darauf, also muss nicht eine Zeichnung stimmen, sondern wie das Zeichen auf jedem Konsonanten sitzt. Ändern Sie das Zeichen hier, und alle ändern sich zugleich.",
      ...
      "lt.note"          : "Ein Buchstabe und ein Laut sind nicht dasselbe. Ein Laut kann auf zwei Arten geschrieben werden, ein Buchstabe auf zwei Arten gelesen, und ein Buchstabe kann da sein, bevor Sie entschieden haben, was er sagt.",
      ...
      "lt.use.d"         : "Welche Buchstaben {0} schreiben. Ein Laut darf mehrere haben.",
      "lt.addsnd"        : "Was er liest",
      "lt.addsnd.d"      : "Geben Sie diesem Buchstaben einen Namen und sagen Sie, welche Laute er liest. Keinen, oder mehrere.",
      "lt.reads"         : "liest {0}",
      ...
      "word.uses"        : "Verwendet in",
      "word.uses.none"   : "Dieses Wort steht noch in keinem Satz.",
      "word.note"        : "Notiz",
      "word.note.d"      : "Was Sie sich zu diesem Wort merken wollen — woher es kommt, womit es nicht zu verwechseln ist.",
      ...
      "word.syn.d"       : "Welche Wörter dasselbe bedeuten wie {0}. Eines zu wählen macht das Paar, in beide Richtungen.",
      ...
      "word.ant.d"       : "Welche Wörter das Gegenteil von {0} bedeuten. Eines zu wählen macht das Paar, in beide Richtungen.",
      "word.ex"          : "Beispiele",
      "word.ex.d"        : "Ein Satz in dieser Sprache und was er bedeutet. Schreiben Sie den Satz mit Leerzeichen zwischen den Wörtern; die schon im Wörterbuch stehen, sind zu hören.",
      "word.ex.ln.ph"    : "Wörter mit Leerzeichen dazwischen",
