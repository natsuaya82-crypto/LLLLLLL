...
defLang('de', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "fmr.what"         : "Schreib einmal auf, wie eine Form gebildet wird, und jedes Wort kann die Formen liefern, die es noch nicht hat. Nichts entsteht, bevor du es verlangst, und was herauskommt ist ein gewöhnliches Wort: ändere es, lösche es, oder schreib selbst eine unregelmäßige Form.",
      ...
      "plan.studio.1"    : "Alles aus Plus",
      "plan.studio.2"    : "Mit einer KI arbeiten: ein Wort aus einer Bedeutung, Grammatik, Beispiele",
      "plan.studio.3"    : "Vorschläge ohne Tageslimit",
      "plan.price.free"  : "0 $",
