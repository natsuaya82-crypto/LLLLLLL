...
defLang('de', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "confirm.wipe"     : "Alles löschen? Dein Konto und jeder Beitrag, jedes Foto und jede Aufnahme gehen vom Server; jede Sprache, jeder Buchstabe und jede Einstellung geht von diesem Telefon, samt den Sicherungsdateien. Nichts lässt sich zurückholen. Kündige dein Abo, bevor du dein Konto löschst.",
      "confirm.wipe.langs": "{0} löschen? Alles darin Erstellte geht verloren: die Wörter, die Buchstaben, das Schriftsystem, die Tastatur, die Notizen und die Laute. Auch die Sicherungsdatei. Sie wird aus deinem Konto entfernt und kommt daher auf keinem anderen Telefon zurück. Deine anderen Sprachen, deine Beiträge und dein Konto bleiben. Dies kann nicht rückgängig gemacht werden.",
