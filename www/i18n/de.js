...
defLang('de', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "cap.hid"                   : "{0} weitere Wörter sind hier und in deiner Sicherung",
      "cap.lapse.h"               : "Dein Tarif ist beendet",
      "cap.lapse.d"               : "Lingua ist wieder auf Gratis, also zeigt das Wörterbuch die ersten 100 Wörter und die Schrift ist wieder ein Alphabet. <b>Es wurde nichts gelöscht.</b> Jedes Wort, jeder Buchstabe und deine Tastatur sind noch hier und noch in deiner Sicherung, und alles kommt zurück, sobald du wieder abonnierst.",
      "cap.lapse.ok"              : "Verstanden",
      ...
      "dir.ttb-rl"    : "Nach unten, Spalten von rechts nach links",
      "dir.ttb-lr"    : "Nach unten, Spalten von links nach rechts",
      "dir.locked"    : "Die Schreibrichtung deiner Sprache wählen",
      "lt.name"          : "Name",
      "lt.name.ph"       : "z. B. esh",
