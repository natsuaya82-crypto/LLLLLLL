...
defLang('de', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.sns.1.n" : "Mara",
      "ob.sns.1.h" : "mara",
      "ob.sns.1.l" : "Alphabet heute fertig. Achtundzwanzig Buchstaben.",
      "ob.sns.2.n" : "Tomas",
      "ob.sns.2.h" : "tomas",
      "ob.sns.2.l" : "Ein Wort für den Geruch nach Regen erfunden.",
      "ob.sns.3.n" : "Ines",
      "ob.sns.3.h" : "ines",
      "ob.sns.3.l" : "Drei Monate, und ich schreibe ganze Sätze.",
      "ob.sns.4.n" : "Kai",
      "ob.sns.4.h" : "kai",
      "ob.sns.4.l" : "Meine Tastatur läuft jetzt auf dem Handy.",
      "ob.sns.5.n" : "Nur",
      "ob.sns.5.h" : "noor",
      "ob.sns.5.l" : "Zahlensystem fertig. Zwölfersystem.",
      "ob.sns.6.n" : "Elias",
      "ob.sns.6.h" : "elias",
      "ob.sns.6.l" : "Sechshundert Wörter. Klingt nach Sprache.",
      "ob.tour.row.letters" : "Tippe auf Buchstaben.",
      "ob.tour.row.words" : "Tippe auf Wortschatz.",
      "ob.tour.row.gram" : "Tippe auf Grammatik.",
      "ob.tour.letters" : "Deine Buchstaben.",
      "ob.tour.words" : "Deine Wörter.",
