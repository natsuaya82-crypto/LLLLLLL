...
defLang('de', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.sns.2.m" : "Ein Wort für den Geruch nach Regen erfunden.",
      "ob.sns.3.n" : "Sela",
      "ob.sns.3.h" : "sela",
      "ob.sns.3.l" : "arun teva mi kastel, ova neri sa.",
      "ob.sns.3.m" : "Drei Monate, und ich schreibe ganze Sätze.",
      "ob.sns.4.n" : "Kai",
      "ob.sns.4.h" : "kai",
      "ob.sns.4.l" : "mel korva anta ve losin.",
      "ob.sns.4.m" : "Meine Tastatur läuft jetzt auf dem Handy.",
      "ob.sns.5.n" : "Nuri",
      "ob.sns.5.h" : "nuri",
      "ob.sns.5.l" : "tavel esko rin, ilma korsa te.",
      "ob.sns.5.m" : "Zahlensystem fertig. Zwölfersystem.",
      "ob.sns.6.n" : "Erim",
      "ob.sns.6.h" : "erim",
      "ob.sns.6.l" : "vasta lome ker un sadi, terin ova.",
      "ob.sns.6.m" : "Sechshundert Wörter. Klingt nach Sprache.",
      "ob.tour.row.letters" : "Tippe auf Buchstaben.",
      "ob.tour.row.gram" : "Tippe auf Grammatik.",
      "ob.tour.letters" : "Deine Buchstaben.",
      "ob.tour.gram" : "Deine Grammatik.",
