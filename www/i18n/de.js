...
defLang('de', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ask.leave"    : "Öffnet eine andere App",
      ...
      "wr.say.build"     : "Blatt gebaut — {0} Bytes",
      "wr.say.build.no"  : "Blatt nicht gebaut — die Namen passen nicht in den Streifen",
      "wr.say.b64"       : "Kodiert — {0} Zeichen",
      "wr.say.b64.no"    : "Kodierung fehlgeschlagen — {0}",
      "wr.say.nobridge"  : "Kein Ort zum Ablegen",
      "wr.say.sent"      : "Ans Telefon übergeben",
      "wr.say.filed"     : "Abgelegt als {0}",
      "wr.say.have"      : "In Sheets — {0} Dateien, neueste {1}",
      "wr.say.have.none" : "In Sheets — nichts da",
      "wr.say.have.no"   : "Konnte nicht in Sheets nachsehen — {0}",
      "wr.say.unnamed"   : "Das Telefon antwortete ohne Dateinamen",
      "wr.say.refused"   : "Das Telefon hat abgelehnt — {0}",
      "wr.say.got"       : "Datei — {0} Bytes",
      "wr.say.kind"      : "Inhalt — {0}",
      "wr.say.jpeg"      : "Foto darin — {0} Bytes",
      "wr.say.jpeg.no"   : "Kein Foto darin",
      "wr.say.draw"      : "Das Telefon wurde gebeten, die Seite zu zeichnen",
      "wr.say.drew"      : "Das Telefon hat sie gezeichnet — {0} Zeichen",
      "wr.say.drew.no"   : "Das Telefon hat nichts gezeichnet",
      "wr.say.read"      : "Gelesen — {0} Namen, {1} mit Tinte",
