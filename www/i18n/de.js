...
defLang('de', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "set.wipe"         : "Daten auf diesem Gerät löschen",
      "set.drop"         : "Konto löschen",
      "set.drop.done"    : "Konto gelöscht",
      "confirm.drop"     : "Konto löschen? Deine Beiträge, Fotos und Aufnahmen werden vom Server entfernt und lassen sich nicht wiederherstellen. Die Sprache auf diesem Gerät bleibt erhalten.",
