...
defLang('de', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "plan.pro.1"      : "Buchstaben hinzufügen, benennen, löschen",
      "plan.pro.2"      : "Eine Silbenschrift, ein Abjad, eine Abugida oder eine Logographie",
      "plan.pro.3"      : "Bis zu drei selbst gelegte Tastaturen",
      "plan.price.free"  : "0 $",
      "plan.pro.6"  : "Laute, Grammatikstufen und die Schreibrichtung selbst wählen",
      "plan.pro.5"  : "Eine Liste als Datei hereinholen und eine hinausgeben",
      "plan.pro.4"  : "Wörter ohne Grenze",
      "plan.each.pro"  : "$8.33",
