...
defLang('de', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "stg.list.d"       : "Eine Grammatik entsteht in Stufen. Jede hält die Wörter, die sie braucht, die Entscheidungen, die sie trägt, und einen Satz, den du sagen kannst, wenn sie fertig ist.",
      ...
      "stg.line"         : "Was du jetzt sagen kannst",
      "stg.make"         : "machen",
      "stg.make.d"       : "Tippe die Laute an, oder nimm einen der Vorschläge.",
      ...
      "stg.own.hint"     : "Höflichkeitsformen, Verwandtschaft, Richtung — was diese Sprache am Ende braucht. Es gibt keine Grenze.",
      "stg.own.h"        : "Eine eigene Stufe",
      "stg.own.d"        : "Gib ihr einen Namen und nenne die Wörter, die sie braucht — eines pro Zeile.",
      ...
      "ws.bases"         : "Die Konsonanten, jeder mit einem Buchstaben",
      "ws.marks"         : "Die Vokale, jeder mit einem Zeichen",
      ...
      "word.sounds.d"    : "Änderst du sie, ändert sich das Wort — überall, wo es benutzt wird.",
      ...
      "add.note.from"    : "Es öffnet sich als das Wort, von dem du es abgeleitet hast. Ändere die Laute von dort aus.",
