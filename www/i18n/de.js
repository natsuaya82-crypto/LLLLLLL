...
defLang('de', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "kb.sys.h"               : "Diese Tastatur kommt auf dein iPhone",
      "kb.sys.1"               : "Einstellungen → Allgemein → Tastatur → Tastaturen → Neue Tastatur hinzufügen → Lingua",
      "kb.sys.2"               : "Einstellungen → Allgemein → Tastatur → Tastaturen → Lingua → Vollzugriff erlauben",
      "kb.sys.full"               : "Ohne Vollzugriff kann sie deine Buchstaben nicht lesen.",
      "kb.out.ok"               : "Deine Buchstaben wurden übergeben.",
      "kb.out.none"               : "Bisher wurde noch nichts übergeben.",
      "kb.out.no"               : "Nichts wurde übergeben: Die App erreicht die Tastatur nicht. Mehr Buchstaben zu zeichnen hilft nicht.",
      "kb.out.bad"               : "Nichts wurde übergeben: {0}",
      ...
      "kb.on.now" : "Diese ist auf deinem Telefon",
      "kb.new" : "Noch eine Tastatur",
      ...
      "plan.plus.2"      : "CSV im Bündel rein und raus",
      "plan.plus.3"      : "Alles aus Free",
      ...
      "plan.price.free"  : "0 $",
      "plan.price.plus"  : "9,99 $ / Monat",
      "plan.price.studio": "19,99 $ / Monat",
      ...
      "word.reg.po"        : "Höflich",
      "word.tags"        : "Bereiche",
      "word.tags.ph"        : "Kochen, Verwandtschaft",
      "word.ety"        : "Herkunft",
      "word.ety.ph"        : "warum dieses Wort so ist",
