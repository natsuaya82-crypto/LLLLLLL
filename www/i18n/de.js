...
defLang('de', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "mod.down"           : "Diesen Beitrag entfernen",
      "mod.up"             : "Wiederherstellen",
      "mod.out"            : "@{0} sperren",
      "mod.in"             : "@{0} entsperren",
      "mod.out.sure"       : "Dieses Konto sperren? Alles bleibt erhalten und Lesen geht weiter, aber Beiträge, Antworten und Reaktionen sind gesperrt, bis du es aufhebst.",
      "post.out"           : "Dein Konto ist gesperrt. Du kannst lesen, aber nichts, was du schreibst, wird veröffentlicht.",
      "post.down"          : "Dieser Beitrag wurde entfernt. Niemand sonst sieht ihn.",
