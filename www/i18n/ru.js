...
defLang('ru', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.signin.local"           : "Только на этом устройстве",
      ...
      "sug.for"                   : "Формы для «{0}»",
      "sug.hint"                  : "Из звуков, которые вы используете",
      ...
      "ab.cell"           : "Нажмите, чтобы нарисовать отдельно",
      "ab.left"           : "Влево",
      "ab.right"          : "Вправо",
      "ab.up"             : "Вверх",
      "ab.down"           : "Вниз",
      ...
      "stg.noun.d"         : "Множественное число и формы",
      "stg.verb.t"         : "Глаголы",
      "stg.verb.d"         : "Время и формы глагола",
      "stg.neg.not"        : "не",
      "stg.ask.why"        : "почему",
      "stg.ask.how"        : "как",
      "stg.conj.t"         : "Связывать",
      "stg.conj.d"         : "Слова, связывающие предложения",
      "stg.conj.and"       : "и",
      "stg.conj.or"        : "или",
      "stg.conj.but"       : "но",
      ...
      "stg.count.t"        : "Считать",
      "stg.count.d"        : "От одного до десяти",
      /* виды письма */
      "ws.kind"           : "Тип письма",
      "ws.k.alpha"        : "Алфавит",
      ...
      "ob.ws.h"           : "Тип письма",
      "ob.ws.sub"         : "　",
      "ob.ws.note"        : "Можно изменить позже",
      "ob.snds.h"         : "Звуки этого языка",
      "ob.snds.sub"       : "　",
      ...
      "make.reroll"       : "Другие варианты",
      "make.pick"         : "Выбрать",
      "make.one"          : "Заново",
      "make.commit"       : "Добавить выбранное",
      ...
      "theme.light"       : "Светлая",
      "theme.dark"        : "Тёмная",
      "set.theme.note"    : "«Система» — как на устройстве",
      ...
      "f.pos"             : "Часть речи",
      "add.btn"           : "Добавить",
      "add.lock.t"        : "Предложить форму",
      "add.lock.d"        : "Из звуков, которые вы используете",
