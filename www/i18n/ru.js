...
defLang('ru', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "cap.hid"                   : "Здесь ещё {0} слов, и они в вашей резервной копии",
      "cap.lapse.h"               : "Ваш план закончился",
      "cap.lapse.d"               : "Lingua вернулась к бесплатному плану, поэтому словарь показывает первые 100 слов, а письмо снова стало алфавитом. <b>Ничего не удалено.</b> Каждое слово, каждая буква и ваша клавиатура на месте и в резервной копии, и всё вернётся, как только вы снова оформите подписку.",
      "cap.lapse.ok"              : "Понятно",
      "ch.clear"                  : "Без знака",
      "ch.for"                    : "Знак для «{0}»",
      "count.script"              : "{0} из {1}",
      ...
      "dir.ttb-rl"    : "Сверху вниз, столбцы справа налево",
      "dir.ttb-lr"    : "Сверху вниз, столбцы слева направо",
      "dir.locked"    : "Выбор направления письма вашего языка",
      "lt.name"           : "Имя",
      "lt.name.ph"        : "напр. эш",
