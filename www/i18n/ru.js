...
defLang('ru', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "word.note"         : "{0} слогов. Сверху — само слово, теми звуками, которые вы выбрали.<br>Рядом с каждым слогом — приблизительное чтение для «{1}» ({2}); кнопка его произносит.",
      "word.note.1"       : "Один слог. Сверху — само слово, теми звуками, которые вы выбрали.<br>Рядом — приблизительное чтение для «{1}» ({2}); кнопка его произносит.",
      "word.note.few"     : "{0} слога. Сверху — само слово, теми звуками, которые вы выбрали.<br>Рядом с каждым слогом — приблизительное чтение для «{1}» ({2}); кнопка его произносит.",
      "word.edit"         : "Изменить",
