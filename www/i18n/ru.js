...
defLang('ru', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "mod.down"            : "Снять эту запись",
      "mod.up"              : "Вернуть",
      "mod.out"             : "Остановить @{0}",
      "mod.in"              : "Вернуть @{0}",
      "mod.out.sure"        : "Остановить этот аккаунт? Всё сохранится и читать можно, но публиковать, отвечать и реагировать не получится, пока вы не отмените.",
      "post.out"            : "Ваш аккаунт остановлен. Читать можно, но написанное не будет опубликовано.",
      "post.down"           : "Эта запись снята. Её больше никто не видит.",
