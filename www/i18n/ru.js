...
defLang('ru', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "fmr.what"         : "Один раз запишите, как образуется форма, и у любого слова можно будет запросить формы, которых у него ещё нет. Ничего не создаётся, пока вы не попросите, а получается обычное слово: правьте его, удаляйте или впишите неправильную форму сами.",
      ...
      "confirm.wipe"      : "Стереть всё на этом телефоне и выйти? Язык, буквы и настройки исчезнут, и это необратимо.",
      "langs.title"       : "Языки",
      ...
      "plan.studio.1"     : "Всё из Plus",
      "plan.studio.2"     : "Работа с ИИ: слово из значения, грамматика, примеры",
      "plan.studio.3"     : "Подсказки без дневного предела",
      "plan.price.free"   : "$0",
      ...
      "tr.go"         : "Прочитать на моём языке",
      "tr.left"         : "осталось сегодня: {0}",
      "tr.out"         : "Сегодняшние три израсходованы. Plus читает все.",
      "word.edit"         : "Изменить",
      "word.save"         : "Сохранить",
