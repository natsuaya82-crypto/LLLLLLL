...
defLang('ru', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "word.syn.d"        : "Какие слова значат то же, что {0}. Выбор делает пару в обе стороны.",
      "word.ant"          : "Слова с противоположным значением",
      "word.ant.none"     : "Пока нет.",
      "word.ant.add"      : "Выбрать слова с противоположным значением",
      "word.ant.d"        : "Какие слова значат противоположное {0}. Выбор делает пару в обе стороны.",
      "word.ex"           : "Примеры",
      "word.ex.d"         : "Строка на этом языке и что она значит. Пишите слова через пробел; те, что уже в словаре, можно услышать.",
      "word.ex.ln.ph"     : "слова через пробел",
