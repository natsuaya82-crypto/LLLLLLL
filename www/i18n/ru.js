...
defLang('ru', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "kb.kb.add"               : "Добавить клавиатуру",
      "kb.kb.del"               : "Удалить эту клавиатуру",
      "kb.del.ask"               : "Удалить эту клавиатуру навсегда? Остальные не изменятся.",
      "kb.del.done"               : "Клавиатура удалена",
      "ipa.b.back"                : "задний",
      ...
      "langs.open"        : "Открыт",
      "langs.more"        : "Бесплатный план позволяет один свой язык. Plus позволяет больше.",
