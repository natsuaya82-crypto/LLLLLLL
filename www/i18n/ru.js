...
defLang('ru', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "kb.title"               : "Клавиатура",
      "kb.locked"               : "На бесплатном тарифе клавиатура — QWERTY с вашими буквами. Plus позволяет собрать свою: клавиши, ряды, слои и свайпы.",
      "kb.key"               : "Клавиша",
      ...
      "lt.dup"     : "{0} уже занят",
      "ws.kind.note"     : "Определяется по вашим буквам, если не выбрать.",
      ...
      "langs.open"        : "Открыт",
      "langs.more"        : "Пока один язык, на любом плане.",
