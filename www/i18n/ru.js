...
defLang('ru', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ask.word.ask" : "Я хочу сделать много слов для этого языка. Предложи около 100 и веди это так, как считаешь нужным — спрашивай, возражай, пробуй направления, о которых я не подумал. Только одно про форму: дай список блоком кода, по одному слову в строке, слово и значение через табуляцию, чтобы я мог вставить его обратно в приложение.",
      "words.more" : "Ещё",
      "words.search"      : "Поиск",
