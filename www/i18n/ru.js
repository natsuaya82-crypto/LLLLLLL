...
defLang('ru', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "kb.sys.h"               : "Эта клавиатура устанавливается на ваш iPhone",
      "kb.sys.full"               : "Без полного доступа она не сможет читать ваши буквы.",
      "kb.sys.go" : "Открыть Настройки",
      "kb.sys.add" : "Только в первый раз: Настройки → Основные → Клавиатура → Клавиатуры → Новые клавиатуры → Lingua",
      "kb.sys.no" : "Настройки не открылись",
      "kb.out.ok"               : "Ваши буквы переданы.",
      "kb.out.none"               : "Пока ничего не передано.",
      "kb.out.no"               : "Ничего не передано: приложение не может связаться с клавиатурой. Рисовать ещё буквы бесполезно.",
      "kb.out.bad"               : "Ничего не передано: {0}",
      ...
      "plan.plus.2"       : "Импорт и экспорт CSV пачкой",
      "plan.plus.3"       : "Всё, что есть в Free",
      ...
      "plan.price.free"   : "$0",
      "plan.price.plus"   : "$9.99 / месяц",
      "plan.price.studio" : "$19.99 / месяц",
      ...
      "word.reg"         : "Регистр",
      "word.reg.none"         : "Обычный",
      "word.reg.sp"         : "Разговорный",
      "word.reg.wr"         : "Книжный",
      "word.reg.sl"         : "Сленг",
      "word.reg.po"         : "Вежливый",
      "word.tags"         : "Области",
      "word.tags.ph"         : "кухня, родство",
      "word.ety"         : "Происхождение",
      "word.ety.ph"         : "почему это слово такое",
      "word.up"         : "Изменено {0}",
      "word.made"         : "Создано {0}",
      "prof.replies"         : "Ответы",
      "prof.likes"         : "Нравится",
