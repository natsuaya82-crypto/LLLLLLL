...
defLang('ru', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "set.wipe"          : "Стереть данные на этом телефоне",
      "set.drop"          : "Удалить аккаунт",
      "set.drop.done"     : "Аккаунт удалён",
      "confirm.drop"      : "Удалить аккаунт? Ваши записи, фотографии и аудио исчезнут с сервера, и вернуть их будет нельзя. Язык на этом телефоне останется на месте.",
