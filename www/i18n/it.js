...
defLang('it', (function(){
  ...
  return {
    ...
    all    : "tutte",
    pos    : {n:"sostantivo", v:"verbo", adj:"aggettivo", adv:"avverbio", pro:"pronome", num:"numerale", part:"particella", conj:"congiunzione", intj:"interiezione", aff:"affisso", nm:"nome proprio", x:"altro"},
    ...
    str    : {
      ...
      "sug.for"                   : "Forme per «{0}»",
      "sug.hint"                  : "Fatto con i suoni che usa",
      ...
      "wld.use"      : "A cosa serve",
      "wld.story"    : "Una storia",
      "wld.story.d"  : "Un libro, un film, un gioco",
      "wld.people"   : "Un popolo",
      "wld.people.d" : "Un popolo non di questa terra",
      "wld.place"    : "Un luogo",
      "wld.place.d"  : "Una valle, un'isola, una città",
      "wld.real"     : "Per essere parlata",
      "wld.real.d"   : "Per usarla davvero",
      "wld.play"     : "Per scoprire",
      "wld.play.d"   : "Per vedere cosa succede",
      "wld.where"    : "Dove si parla",
      "wld.where.ph" : "le valli del nord",
      "wld.who"      : "Chi la parla",
      "wld.who.ph"   : "la gente del fiume",
      "wld.note"     : "Note",
      "wld.note.ph"  : "Qualsiasi cosa su dove vive questa lingua.",
      ...
      "ab.cell"          : "Ne tocchi una per disegnarla a parte",
      "ab.left"          : "A sinistra",
      "ab.right"         : "A destra",
      "ab.up"            : "In alto",
      "ab.down"          : "In basso",
      ...
      "lt.addsnd"        : "Lettura",
      "lt.reads"         : "legge {0}",
      "lt.reads.none"    : "non legge ancora niente",
      "lt.reads.h"       : "Legge",
      "lt.name"          : "Nome",
      "lt.name.ph"       : "p. es. esh",
      "lt.loose"         : "{0} lettere non leggono ancora niente.",
      "lt.loose.1"       : "Una lettera non legge ancora niente.",
      "lt.role"          : "A cosa serve questa lettera",
      "lt.role.snd"      : "Legge un suono",
      "lt.role.mark"     : "Un segno",
      "lt.mark.key"      : "Si digita come",
      "lt.mark.none"     : "Non impostato",
      "lt.marks"         : "Segni",
      "toc.gram"         : "Grammatica",
      "toc.make"         : "Coniarne diverse",
      /* what the app proposes */
      "as.soft"         : "Morbido",
      "as.soft.d"       : "Nasali, l e r, vocali semplici — come il giapponese o l'italiano",
      "as.hard"         : "Duro",
      "as.hard.d"       : "Occlusive e sibilanti, poche vocali — come il georgiano",
      "as.flowing"      : "Scorrevole",
      "as.flowing.d"    : "Suoni sonori, cinque vocali",
      "as.breathy"      : "Aspirato",
      "as.breathy.d"    : "Fricative e h — come l'arabo o il gallese",
      "as.plain"        : "Semplice",
      "as.plain.d"      : "Un insieme piccolo, facile — come l'hawaiano",
      "as.hear"         : "Ascoltare tutto",
      "as.again"        : "Un altro insieme",
      "as.own"          : "Scegliere io",
      "as.drop"         : "Togliere",
      "as.more.c"       : "Aggiungere una consonante",
      "as.more.v"       : "Aggiungere una vocale",
      ...
      "stg.ex"           : "Frasi",
      "stg.ex.lb.ph"     : "",
      "stg.noun.t"       : "Sostantivi",
      "stg.noun.d"       : "Il plurale e le forme del sostantivo",
      "stg.verb.t"       : "Verbi",
      "stg.verb.d"       : "Il tempo e le forme del verbo",
      "stg.neg.not"      : "non",
      "stg.ask.why"      : "perché",
      "stg.ask.how"      : "come",
      "stg.conj.t"       : "Legare",
      "stg.conj.d"       : "Le parole che legano le frasi",
      "stg.conj.and"     : "e",
      "stg.conj.or"      : "o",
      "stg.conj.but"     : "ma",
      ...
      "stg.when.d"       : "Quando succede",
      "stg.decide"       : "Decidere",
      "stg.note"         : "Note",
      "stg.note.ph"      : "Qualsiasi cosa su questa parte della grammatica.",
      "stg.make"         : "farla",
      "stg.keep"         : "Salvare",
      "stg.drop"         : "Cancellare la parola",
      "stg.help"         : "Proposte",
      "stg.help.d"       : "Fatto con i suoni che usa",
      "stg.again"        : "Altre",
      ...
      "stg.neg.d"        : "Come si dice il contrario",
      "stg.ask.t"        : "Chiedere",
      ...
      "ob.snds.h"        : "Suoni di questa lingua",
      "ob.snds.sub"      : "　",
      "ob.snds.n"        : "{0} suoni scelti",
      "ob.snds.n.1"      : "1 suono scelto",
      "ob.snds.note"     : "La tabella intera viene dopo",
      "ob.snds.need"     : "Scelga un suono",
      "ob.draw.h"       : "Disegna una lettera",
      "ob.read.h"       : "Che cosa legge?",
      "ob.read.sub"       : "Scegli un suono, o fanne un segno. Puoi decidere dopo.",
      "ob.read.mark"       : "Oppure un segno",
      "ob.read.later"       : "Decidere dopo",
      ...
      "home.empty.btn"   : "Prima parola",
      "home.recent.line" : "Ultima frase",
      "home.recent.word" : "Ultima parola",
      "home.write"       : "Parola nuova",
      "words.search"     : "Cerca grafia, significato, lettura",
      "words.clear"      : "Cancellare",
      "words.n"          : "{0} parole",
      "words.n.1"        : "Una parola",
      "words.sort.a"     : "Per suono",
      "words.sort.new"   : "Le più recenti prima",
      "words.kids"       : "{0} derivate",
      "words.kids.1"     : "Una derivata",
      "words.open"       : "Aprire",
      "words.sayall"     : "Ascoltare tutto",
      "words.stop"       : "Fermare",
      ...
      "talk.gram"        : "Parole di grammatica",
      "gram.demo.need"   : "Scriva ancora qualche parola",
      "gram.pair.phrase" : "gruppo",
      "gram.pair.line"   : "riga",
      "gram.seen"        : "Quello che mostrano le sue parole",
      "rules.empty.t"    : "Ancora nessuna regola",
      "rules.empty.s"    : "Scriva prima qualche parola",
      "rules.next"       : "Poi: {0}",
      ...
      "make.reroll"      : "Altre proposte",
      "make.pick"        : "Scegliere",
      "make.one"         : "Rigenerare",
      "make.commit"      : "Aggiungere la selezione",
      ...
      "theme.light"      : "Chiaro",
      "theme.dark"       : "Scuro",
      "set.theme.note"   : "«Sistema» segue l'apparecchio",
      ...
      "add.btn"          : "Aggiungi",
      "add.lock.t"       : "Proporre una forma",
      "add.lock.d"       : "Fatto con i suoni che usa",
      ...
      "word.note.ph"     : "qualsiasi cosa su questa parola",
