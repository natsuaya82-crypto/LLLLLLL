...
defLang('it', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "wr.out.ok"        : "Salvato",
      "wr.say.build"     : "Foglio creato — {0} byte",
      "wr.say.build.no"  : "Foglio non creato — i nomi non stanno nella striscia",
      "wr.say.b64"       : "Codificato — {0} caratteri",
      "wr.say.b64.no"    : "La codifica ha fallito — {0}",
      "wr.say.nobridge"  : "Non c’è dove metterlo",
      "wr.say.sent"      : "Consegnato al telefono",
      "wr.say.filed"     : "Salvato come {0}",
      "wr.say.have"      : "In Sheets — {0} file, il più recente {1}",
      "wr.say.have.none" : "In Sheets — non c’è nulla",
      "wr.say.have.no"   : "Impossibile guardare in Sheets — {0}",
      "wr.say.unnamed"   : "Il telefono ha risposto senza nome di file",
      "wr.say.refused"   : "Il telefono ha rifiutato — {0}",
      "wr.say.got"       : "File — {0} byte",
      "wr.say.kind"      : "Contenuto — {0}",
      "wr.say.jpeg"      : "Foto dentro — {0} byte",
      "wr.say.jpeg.no"   : "Nessuna foto dentro",
      "wr.say.draw"      : "Chiesto al telefono di disegnare la pagina",
      "wr.say.drew"      : "Il telefono l’ha disegnata — {0} caratteri",
      "wr.say.drew.no"   : "Il telefono non ha disegnato nulla",
      "wr.say.read"      : "Letto — {0} nomi, {1} con inchiostro",
