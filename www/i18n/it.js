...
defLang('it', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.sns.1.n" : "Mara",
      "ob.sns.1.h" : "mara",
      "ob.sns.1.l" : "Alfabeto finito oggi. Ventotto lettere.",
      "ob.sns.2.n" : "Tommaso",
      "ob.sns.2.h" : "tomas",
      "ob.sns.2.l" : "Ho inventato una parola per l'odore di pioggia.",
      "ob.sns.3.n" : "Ines",
      "ob.sns.3.h" : "ines",
      "ob.sns.3.l" : "Tre mesi e scrivo una frase intera.",
      "ob.sns.4.n" : "Kai",
      "ob.sns.4.h" : "kai",
      "ob.sns.4.l" : "La mia tastiera funziona sul telefono.",
      "ob.sns.5.n" : "Nur",
      "ob.sns.5.h" : "noor",
      "ob.sns.5.l" : "Sistema di numerazione finito. Base dodici.",
      "ob.sns.6.n" : "Elia",
      "ob.sns.6.h" : "elias",
      "ob.sns.6.l" : "Seicento parole. Suona come una lingua.",
      "ob.tour.row.letters" : "Tocca Lettere.",
      "ob.tour.row.words" : "Tocca Lessico.",
      "ob.tour.row.gram" : "Tocca Grammatica.",
      "ob.tour.letters" : "Le tue lettere.",
      "ob.tour.words" : "Le tue parole.",
