...
defLang('it', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "cap.hid"                   : "Ci sono altre {0} parole qui, e nel tuo backup",
      "cap.lapse.h"               : "Il tuo piano è finito",
      "cap.lapse.d"               : "Lingua è tornata a Gratis, quindi il dizionario elenca le prime 100 parole e la scrittura è di nuovo un alfabeto. <b>Non è stato cancellato nulla.</b> Ogni parola, ogni lettera e la tua tastiera sono ancora qui e sono ancora nel tuo backup, e tornano tutte appena ti riabboni.",
      "cap.lapse.ok"              : "Ho capito",
      ...
      "dir.ttb-rl"    : "Verso il basso, colonne da destra a sinistra",
      "dir.ttb-lr"    : "Verso il basso, colonne da sinistra a destra",
      "dir.locked"    : "Scegliere la direzione della tua lingua",
      "lt.name"          : "Nome",
      "lt.name.ph"       : "p. es. esh",
