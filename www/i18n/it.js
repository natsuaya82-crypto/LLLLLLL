...
defLang('it', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "word.syn.d"       : "Quali parole vogliono dire lo stesso di {0}. Sceglierne una fa la coppia, nei due sensi.",
      ...
      "word.ant.d"       : "Quali parole vogliono dire il contrario di {0}. Sceglierne una fa la coppia, nei due sensi.",
      "word.ex"          : "Esempi",
      "word.ex.d"        : "Una frase in questa lingua e cosa vuol dire. Scriva la frase con le parole separate da spazi; quelle già nel dizionario si sentono.",
      "word.ex.ln.ph"    : "parole separate da spazi",
