...
defLang('it', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "word.note"        : "{0} sillabe. Sopra c'è la parola stessa, nei suoni che hai scelto.<br>Accanto a ogni sillaba c'è la lettura approssimata per chi parla {1} ({2}); il pulsante la dice.",
      "word.note.1"      : "Una sillaba. Sopra c'è la parola stessa, nei suoni che hai scelto.<br>Accanto c'è la lettura approssimata per chi parla {1} ({2}); il pulsante la dice.",
      "word.edit"        : "Modifica",
