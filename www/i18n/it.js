...
defLang('it', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "set.wipe"         : "Cancella i dati di questo telefono",
      "set.drop"         : "Elimina account",
      "set.drop.done"    : "Account eliminato",
      "confirm.drop"     : "Eliminare il tuo account? I tuoi post, le foto e le registrazioni spariscono dal server e non si possono recuperare. La lingua su questo telefono resta dov'è.",
