...
defLang('it', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "plan.pro.1"      : "Aggiungere lettere, dar loro un nome, cancellarle",
      "plan.pro.2"      : "Un sillabario, un abjad, un abugida o una logografia",
      "plan.pro.3"      : "Fino a tre tastiere disposte da te",
      "plan.price.free"  : "$0",
      "plan.pro.6"  : "Scegliere i suoni, le fasi della grammatica e il verso della scrittura",
      "plan.pro.5"  : "Portare dentro un elenco come file e portarne fuori uno",
      "plan.pro.4"  : "Parole senza limite",
      "plan.each.pro"  : "$8.33",
