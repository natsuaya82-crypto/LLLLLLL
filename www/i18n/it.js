...
defLang('it', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "mod.down"           : "Rimuovi questo post",
      "mod.up"             : "Ripristina",
      "mod.out"            : "Blocca @{0}",
      "mod.in"             : "Sblocca @{0}",
      "mod.out.sure"       : "Bloccare questo account? Resta tutto e può leggere, ma non potrà pubblicare, rispondere o reagire finché non annulli.",
      "post.out"           : "Il tuo account è bloccato. Puoi leggere, ma nulla di ciò che scrivi verrà pubblicato.",
      "post.down"          : "Questo post è stato rimosso. Nessun altro può vederlo.",
