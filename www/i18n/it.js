...
defLang('it', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "cap.lapse.d"               : "Non è stato cancellato nulla di ciò che hai creato. Le tue parole, lettere, tastiere, grammatica e i tuoi post sono ancora tutti sul tuo account, esattamente com’erano.<br><br>Con il piano Gratis il dizionario mostra fino a 100 parole, una tastiera e una lingua. Le parole dopo la 100 non sono sparite. Semplicemente non vengono mostrate.<br><br>Se torni a un piano a pagamento, torna tutto com’era.",
      "cap.lapse.ok"              : "Chiudi",
      ...
      "toast.cap"        : "Questo piano tiene {0} parole. Con Pro puoi usarlo senza limiti.",
      "toast.cap.1"      : "Questo piano tiene una parola. Con Pro puoi usarlo senza limiti.",
      ...
      "confirm.wipe"     : "Cancellare tutto? Il tuo account e ogni post, fotografia e registrazione se ne vanno dal server; ogni lingua, lettera e impostazione se ne va da questo telefono, insieme ai file di backup. Nulla può essere recuperato. Annulla l'abbonamento prima di eliminare l'account.",
      "confirm.wipe.langs": "Eliminare {0}? Tutto ciò che vi è stato creato scompare: le parole, le lettere, il sistema di scrittura, la tastiera, le note e i suoni. Anche il file di backup. Viene rimossa dal tuo account, quindi non tornerà su un altro telefono. Le altre lingue, i tuoi post e il tuo account restano. Non è reversibile.",
      "langs.title"      : "Lingue",
