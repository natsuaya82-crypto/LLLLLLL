...
defLang('it', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.sns.2.m" : "Ho inventato una parola per l'odore di pioggia.",
      "ob.sns.3.n" : "Sela",
      "ob.sns.3.h" : "sela",
      "ob.sns.3.l" : "arun teva mi kastel, ova neri sa.",
      "ob.sns.3.m" : "Tre mesi e scrivo una frase intera.",
      "ob.sns.4.n" : "Kai",
      "ob.sns.4.h" : "kai",
      "ob.sns.4.l" : "mel korva anta ve losin.",
      "ob.sns.4.m" : "La mia tastiera funziona sul telefono.",
      "ob.sns.5.n" : "Nuri",
      "ob.sns.5.h" : "nuri",
      "ob.sns.5.l" : "tavel esko rin, ilma korsa te.",
      "ob.sns.5.m" : "Sistema di numerazione finito. Base dodici.",
      "ob.sns.6.n" : "Erim",
      "ob.sns.6.h" : "erim",
      "ob.sns.6.l" : "vasta lome ker un sadi, terin ova.",
      "ob.sns.6.m" : "Seicento parole. Suona come una lingua.",
      "ob.tour.row.letters" : "Tocca Lettere.",
      "ob.tour.row.gram" : "Tocca Grammatica.",
      "ob.tour.letters" : "Le tue lettere.",
      "ob.tour.gram" : "La tua grammatica.",
