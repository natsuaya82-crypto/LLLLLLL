...
defLang('it', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "wr.s3"            : "Stamparlo e scrivere",
      "wr.s3.d"          : "Una lettera per casella.",
      "wr.s4"            : "Scansionarlo e installare",
      "wr.s4.d"          : "Restituire qui la scansione in PDF.",
      "wr.names"         : "Nomi",
      "wr.ph"            : "7, 2, 25",
      "wr.boxes"         : "{0} caselle",
      ...
      "wr.in"            : "Scegliere un PDF scansionato",
