...
defLang('it', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "wld.ask"      : "A cosa serve?",
      "wld.use"      : "A cosa serve",
      "wld.story"    : "Una storia",
      "wld.story.d"  : "Qualcuno di un libro, un film, un gioco la parla.",
      "wld.people"   : "Un popolo",
      "wld.people.d" : "Un popolo che non sta su questa terra, o che ci stava.",
      "wld.place"    : "Un luogo",
      "wld.place.d"  : "Una valle, un'isola, una città, e come si parla lì.",
      "wld.real"     : "Per essere parlata",
      "wld.real.d"   : "Fatta per usarla davvero, con qualcuno o da soli.",
      "wld.play"     : "Per scoprire",
      "wld.play.d"   : "Fatta per vedere cosa succede se una lingua funziona così.",
      "wld.where"    : "Dove si parla",
      "wld.where.ph" : "le valli del nord",
      "wld.who"      : "Chi la parla",
      "wld.who.ph"   : "la gente del fiume",
      "wld.note"     : "Su questo mondo",
      ...
      "find.ph"          : "Cercare in questa lingua",
      ...
      "ab.cell"          : "Ne tocchi una per disegnare quella combinazione da sola, quando il segno non ci viene bene.",
      "ab.left"          : "A sinistra",
      "ab.right"         : "A destra",
      "ab.up"            : "In alto",
      "ab.down"          : "In basso",
      ...
      "ab.nomark"        : "Questa vocale non ha ancora un segno disegnato.",
      "ab.nocons"        : "Ancora nessuna consonante.",
      "ab.novow"         : "Ancora nessuna vocale.",
      "ab.notabugida"    : "Questa lingua non si scrive come abugida.",
      "lt.all"           : "Tutte le lettere",
      "lt.none"          : "Ancora nessuna lettera.",
      "lt.new"           : "Una lettera nuova",
      "lt.untitled"      : "Senza nome",
      "lt.draw"          : "Disegnare una lettera",
      "lt.use"           : "Usare una lettera che esiste",
      "lt.addsnd"        : "Cosa legge",
      "lt.reads"         : "legge {0}",
      "lt.reads.none"    : "non legge ancora niente",
      "lt.reads.h"       : "Suoni che questa lettera legge",
      "lt.name"          : "Nome",
      "lt.name.ph"       : "p. es. esh",
      ...
      "stg.noun.d"       : "Più di uno, e le forme che prende un sostantivo.",
      "stg.verb.t"       : "Verbi",
      "stg.verb.d"       : "Il tempo, e in cosa diventa un verbo quando cambia.",
      "stg.neg.not"      : "non",
      "stg.ask.why"      : "perché",
      "stg.ask.how"      : "come",
      "stg.conj.t"       : "Legare",
      "stg.conj.d"       : "e, o, ma — e le parole che appendono una frase a un'altra.",
      "stg.conj.and"     : "e",
      "stg.conj.or"      : "o",
      "stg.conj.but"     : "ma",
      ...
      "stg.part.d"       : "Parole piccole che segnano cosa fa una parola nella frase.",
      "stg.polite.t"     : "Cortesia",
      "stg.polite.d"     : "Come cambia la lingua quando parla con riguardo.",
      "stg.where.t"      : "Luogo",
      "stg.where.in"     : "in",
      "stg.where.on"     : "su",
      ...
      "stg.where.from"   : "da",
      "stg.where.with"   : "con",
      "stg.where.d"      : "Dov'è una cosa e dove va.",
      "stg.when.t"       : "Tempo",
      "stg.when.now"     : "adesso",
      ...
      "stg.when.d"       : "Quando succede una cosa.",
      "stg.decide"       : "Decidere",
      ...
      "words.clear"      : "Cancellare la ricerca",
      "words.n"          : "{0} parole",
      ...
      "word.note"        : "Nota",
      "word.sp"          : "Questa lettera qui",
      "word.sp.none"     : "Prema le lettere",
      "word.sp.del"      : "Togliere questa lettera",
      ...
      "word.ex.del"      : "Cancellare questo esempio",
      ...
      "csv.title"        : "Riprendere un elenco",
