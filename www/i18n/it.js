...
defLang('it', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "snd.empty" : "Ancora nessun suono",
      "snd.nolt" : "nessuna lettera lo dice",
      ...
      "fmr.what"         : "Scrivi una volta come si fa una forma e qualsiasi parola potrà dare le forme che ancora non ha. Niente viene creato finché non lo chiedi, e ciò che esce è una parola normale: modificala, cancellala, oppure scrivi tu una forma irregolare.",
      "fmr.new"          : "Scrivere una regola",
      "fmr.any"          : "Qualsiasi parola",
      "fmr.pos"          : "Parole a cui si applica",
      "fmr.fm"           : "Forma che produce",
      ...
      "confirm.wipe"     : "Cancellare tutto su questo telefono e uscire? La lingua, le lettere e le impostazioni spariscono, e non si torna indietro.",
      "langs.title"      : "Lingue",
      ...
      "plan.plus.2"      : "Un sillabario, un abjad, un abugida o una logografia",
      "plan.plus.3"      : "Fino a tre tastiere disposte da te",
      "plan.studio.2"    : "Lavorare con un'IA: una parola da un significato, la grammatica, gli esempi",
      "plan.price.free"  : "$0",
      "plan.studio.3"  : "Suggerimenti senza limite giornaliero",
      "plan.studio.1"  : "Tutto quello che c'è in Plus",
      "plan.plus.6"  : "Scegliere i suoni, le fasi della grammatica e il verso della scrittura",
      "plan.plus.5"  : "Portare dentro un elenco come file e portarne fuori uno",
      "plan.plus.4"  : "Parole senza limite",
      "plan.each.studio"  : "$16.67",
      "plan.each.plus"  : "$8.33",
      "plan.price.studio.yr"  : "$199.99",
      "plan.price.plus.yr"  : "$99.99",
      "plan.each"  : "{0} al mese, addebitato una volta l'anno",
      "plan.per.yr"  : "/ anno",
      "plan.per.mo"  : "/ mese",
      "plan.save"  : "2 mesi gratis",
      "plan.term.yr"  : "Annuale",
      "plan.term.mo"  : "Mensile",
      ...
      "post.pinned"        : "Fissato",
      "post.pic"        : "Foto",
      "post.pic.again"        : "Cambiare la foto",
      "post.pic.drop"        : "Togliere la foto",
      "post.mark"            : "Lettere",
      "post.mark.add"        : "Aggiungi una lettera",
      "post.mark.del"        : "Togli",
