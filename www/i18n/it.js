...
defLang('it', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "find.mine.d"      : "Grafia, significato o lettura — da qualsiasi punto della lingua.",
      ...
      "ab.d"             : "In un'abugida una lettera è una consonante con un segno vocalico sopra, quindi quello che deve venire giusto non è un disegno ma come il segno si posa su ogni consonante. Cambi il segno qui e cambiano tutte insieme.",
      ...
      "lt.note"          : "Una lettera e un suono non sono la stessa cosa. Un suono può scriversi in due modi, una lettera può leggersi in due modi, e una lettera può esistere prima che lei abbia deciso cosa dice.",
      ...
      "lt.use.d"         : "Quali lettere scrivono {0}. Un suono può averne più di una.",
      "lt.addsnd"        : "Cosa legge",
      "lt.addsnd.d"      : "Dia un nome a questa lettera e dica quali suoni legge. Può non leggerne nessuno, o parecchi.",
      "lt.reads"         : "legge {0}",
      ...
      "word.uses"        : "Usata in",
      "word.uses.none"   : "Questa parola non compare ancora in nessuna frase.",
      "word.note"        : "Nota",
      "word.note.d"      : "Quello che vuole ricordare di questa parola: da dove viene, con cosa non va confusa.",
