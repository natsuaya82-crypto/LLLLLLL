...
defLang('it', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "kb.sys.h"               : "Questa tastiera si installa sul tuo iPhone",
      "kb.sys.1"               : "Impostazioni → Generali → Tastiera → Tastiere → Nuova tastiera → Lingua",
      "kb.sys.2"               : "Impostazioni → Generali → Tastiera → Tastiere → Lingua → Consenti accesso completo",
      "kb.sys.full"               : "Senza l’accesso completo non può leggere le tue lettere.",
      "kb.out.ok"               : "Le tue lettere sono state consegnate.",
      "kb.out.none"               : "Non è stato ancora consegnato nulla.",
      "kb.out.no"               : "Non è stato consegnato nulla: l’app non riesce a raggiungere la tastiera. Disegnare altre lettere non aiuterà.",
      "kb.out.bad"               : "Non è stato consegnato nulla: {0}",
      ...
      "kb.on.now" : "Questa è quella sul tuo telefono",
      "kb.new" : "Un’altra tastiera",
      ...
      "plan.plus.2"      : "Importare ed esportare CSV in blocco",
      "plan.plus.3"      : "Tutto quello che c’è in Free",
      ...
      "plan.price.free"  : "$0",
      "plan.price.plus"  : "$9.99 / mese",
      "plan.price.studio": "$19.99 / mese",
      ...
      "word.reg.po"        : "Cortese",
      "word.tags"        : "Ambiti",
      "word.tags.ph"        : "cucina, parentela",
      "word.ety"        : "Origine",
      "word.ety.ph"        : "perché questa parola è così",
