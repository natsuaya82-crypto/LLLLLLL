...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "wld.ask"      : "À quoi sert-elle ?",
      "wld.use"      : "À quoi elle sert",
      "wld.story"    : "Une histoire",
      "wld.story.d"  : "Quelqu'un d'un livre, d'un film, d'un jeu la parle.",
      "wld.people"   : "Un peuple",
      "wld.people.d" : "Un peuple qui n'est pas sur cette terre, ou qui y était.",
      "wld.place"    : "Un lieu",
      "wld.place.d"  : "Une vallée, une île, une ville, et la façon d'y parler.",
      "wld.real"     : "Pour être parlée",
      "wld.real.d"   : "Faite pour servir vraiment, à deux ou seul.",
      "wld.play"     : "Pour voir",
      "wld.play.d"   : "Faite pour voir ce que donne une langue qui marche ainsi.",
      "wld.where"    : "Où on la parle",
      "wld.where.ph" : "les vallées du nord",
      "wld.who"      : "Qui la parle",
      "wld.who.ph"   : "les gens du fleuve",
      "wld.note"     : "Sur ce monde",
      ...
      "ab.cell"          : "Touchez-en une pour dessiner cette combinaison à part, quand la marque ne tombe pas juste dessus.",
      ...
      "ab.nomark"        : "Cette voyelle n'a pas encore de marque dessinée.",
      "ab.nocons"        : "Pas encore de consonnes.",
      "ab.novow"         : "Pas encore de voyelles.",
      "ab.notabugida"    : "Cette langue ne s'écrit pas en abugida.",
      ...
      "stg.ex.lb.ph"     : "",
      "stg.noun.t"       : "Noms",
      "stg.noun.d"       : "Plus d'un, et les formes que prend un nom.",
      "stg.verb.t"       : "Verbes",
      "stg.verb.d"       : "Le temps, et ce que devient un verbe quand il change.",
      "stg.neg.not"      : "ne pas",
      "stg.ask.why"      : "pourquoi",
      "stg.ask.how"      : "comment",
      "stg.conj.t"       : "Relier",
      "stg.conj.d"       : "et, ou, mais — et les mots qui accrochent une proposition à une autre.",
      "stg.conj.and"     : "et",
      "stg.conj.or"      : "ou",
      "stg.conj.but"     : "mais",
      ...
      "stg.part.d"       : "Petits mots qui marquent ce qu'un mot fait dans la phrase.",
      "stg.polite.t"     : "Politesse",
      "stg.polite.d"     : "Comment la langue change quand elle prend des précautions.",
      "stg.where.t"      : "Lieu",
      "stg.where.in"     : "dans",
      "stg.where.on"     : "sur",
      ...
      "stg.where.from"   : "de",
      "stg.where.with"   : "avec",
      "stg.where.d"      : "Où une chose est, et où elle va.",
      "stg.when.t"       : "Temps",
      ...
      "stg.when.d"       : "Quand une chose arrive.",
      "stg.decide"       : "Décider",
