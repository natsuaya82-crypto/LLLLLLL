...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "kb.step1" : "Ajouter Lingua comme clavier",
      "kb.step1.d" : "Réglages → Général → Clavier → Claviers → Ajouter un clavier → Lingua",
      "kb.step2" : "Dans les réglages de Lingua, touchez Claviers",
      "kb.step3" : "Activez Autoriser l'accès complet",
