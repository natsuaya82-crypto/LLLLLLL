...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "mod.down"           : "Retirer ce billet",
      "mod.up"             : "Rétablir",
      "mod.out"            : "Suspendre @{0}",
      "mod.in"             : "Rétablir @{0}",
      "mod.out.sure"       : "Suspendre ce compte ? Tout est conservé et la lecture reste possible, mais plus de billets, de réponses ni de réactions jusqu’à ce que vous l’annuliez.",
      "post.out"           : "Votre compte est suspendu. Vous pouvez lire, mais rien de ce que vous écrivez ne sera publié.",
      "post.down"          : "Ce billet a été retiré. Personne d’autre ne le voit.",
