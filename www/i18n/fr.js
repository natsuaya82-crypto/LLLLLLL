...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ab.d"             : "Dans une abugida une lettre est une consonne portant une marque vocalique, donc ce qui doit tomber juste n'est pas un dessin mais la façon dont la marque se pose sur chaque consonne. Changez la marque ici et toutes changent ensemble.",
      ...
      "word.syn.d"       : "Quels mots veulent dire la même chose que {0}. En choisir un fait la paire, dans les deux sens.",
      ...
      "word.ant.d"       : "Quels mots veulent dire le contraire de {0}. En choisir un fait la paire, dans les deux sens.",
      "word.ex"          : "Exemples",
      "word.ex.d"        : "Une phrase dans cette langue et ce qu'elle veut dire. Écrivez la phrase en séparant les mots par des espaces ; ceux qui sont déjà au dictionnaire peuvent s'entendre.",
      "word.ex.ln.ph"    : "mots séparés par des espaces",
