...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "set.wipe"         : "Effacer les données de ce téléphone",
      "set.drop"         : "Supprimer le compte",
      "set.drop.done"    : "Compte supprimé",
      "confirm.drop"     : "Supprimer votre compte ? Vos publications, photos et enregistrements quittent le serveur et ne pourront pas être récupérés. La langue sur ce téléphone reste en place.",
