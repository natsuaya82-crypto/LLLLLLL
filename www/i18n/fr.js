...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "plan.pro.1"      : "Ajouter des lettres, les nommer, les supprimer",
      "plan.pro.2"      : "Un syllabaire, un abjad, un abugida ou une logographie",
      "plan.pro.3"      : "Jusqu'à trois claviers que vous disposez vous-même",
      "plan.price.free"  : "0 $",
      "plan.pro.6"  : "Choisir les sons, les étapes de grammaire et le sens d'écriture",
      "plan.pro.5"  : "Importer une liste comme fichier, en exporter une",
      "plan.pro.4"  : "Des mots sans limite",
      "plan.each.pro"  : "$8.33",
