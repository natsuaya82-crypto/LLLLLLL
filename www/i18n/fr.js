...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "kb.kb.add"               : "Ajouter un clavier",
      "kb.kb.del"               : "Supprimer ce clavier",
      "kb.del.ask"               : "Supprimer ce clavier définitivement ? Les autres restent intacts.",
      "kb.del.done"               : "Clavier supprimé",
      ...
      "langs.open"       : "Ouverte",
      "langs.more"       : "Le plan gratuit permet une langue à vous. Plus en permet davantage.",
