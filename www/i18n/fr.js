...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "kb.title"               : "Clavier",
      "kb.locked"               : "Avec le forfait gratuit, le clavier est un QWERTY avec vos propres lettres. Plus vous laisse construire le vôtre : touches, rangées, couches et glissés.",
      "kb.key"               : "Touche",
      ...
      "kb.sys.h"               : "Ce clavier s’installe sur votre iPhone",
      "kb.sys.1"               : "Réglages → Général → Clavier → Claviers → Ajouter un clavier → Lingua",
      "kb.sys.2"               : "Réglages → Général → Clavier → Claviers → Lingua → Autoriser l’accès complet",
      "kb.sys.full"               : "Sans l’accès complet, il ne peut pas lire vos lettres.",
      "kb.out.ok"               : "Vos lettres ont été transmises.",
      "kb.out.none"               : "Rien n’a encore été transmis.",
      "kb.out.no"               : "Rien n’a été transmis : l’app n’arrive pas à joindre le clavier. Dessiner plus de lettres n’y changera rien.",
      "kb.out.bad"               : "Rien n’a été transmis : {0}",
      ...
      "lt.reads.no"     : "Illisible",
      "lt.dup"     : "{0} est déjà pris",
      "ws.kind.note"     : "Déduit de vos lettres sauf indication contraire.",
      ...
      "ipa.feel"         : "Un ensemble pour commencer",
      ...
      "langs.open"       : "Ouverte",
      "langs.more"       : "Pour l'instant, une langue sur tous les plans.",
      ...
      "plan.plus.2"      : "Importer et exporter en CSV, en lot",
      "plan.plus.3"      : "Tout ce que Free contient",
      ...
      "plan.price.free"  : "0 $",
      "plan.price.plus"  : "9,99 $ / mois",
      "plan.price.studio": "19,99 $ / mois",
      ...
      "word.reg"        : "Registre",
      "word.reg.none"        : "Neutre",
      "word.reg.sp"        : "Oral",
      "word.reg.wr"        : "Écrit",
      "word.reg.sl"        : "Argot",
      "word.reg.po"        : "Poli",
      "word.tags"        : "Domaines",
      "word.tags.ph"        : "cuisine, parenté",
      "word.ety"        : "Origine",
      "word.ety.ph"        : "pourquoi ce mot est ainsi",
      ...
      "post.pinned"        : "Épinglé",
      "post.pic"        : "Photo",
      "post.pic.again"        : "Changer la photo",
      "post.pic.drop"        : "Retirer la photo",
      "post.mark"            : "Lettres",
      "post.mark.add"        : "Ajouter une lettre",
