...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "hp.lt.ab.d" : "Quand la langue est un abugida, une ligne en haut ouvre la place des voyelles.",
      ...
      "hp.bk.p" : "Écrite en blocs, une syllabe est une case. Chaque lettre reste là où elle a été dessinée, à la taille où elle a été dessinée, et les lettres d’une syllabe se superposent.",
      "hp.bk.1" : "Dessinez dans un quart",
      "hp.bk.1.d" : "La case est coupée en quatre. Dessinez une consonne en haut à gauche et une voyelle en haut à droite : la syllabe les met côte à côte.",
      "hp.bk.2" : "Finales",
      "hp.bk.2.d" : "Une finale dessinée dans la moitié haute descend d’une demi-case : la première en bas à gauche, une deuxième en bas à droite.",
      "hp.bk.3" : "Quatre au plus",
      "hp.bk.3.d" : "Une syllabe de plus de quatre lettres, ou avec plus de deux finales, n’est pas assemblée.",
