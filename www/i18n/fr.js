...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "gram.demo.need.adj": "Il faut un adjectif.",
      "gram.demo.need.nadj": "Il faut un nom et un adjectif.",
      "gram.pair.phrase" : "groupe",
      "gram.pair.line"   : "ligne",
      "words.addmn"      : "Ajouter un sens",
      "toast.cap"        : "Cette formule contient {0} mots. Avec Pro, vous pouvez l’utiliser sans limite.",
      "set.title"        : "Réglages",
      "set.look"         : "Affichage",
      ...
      "confirm.wipe.langs": "Supprimer {0} ? Tout ce qui y a été créé disparaît : les mots, les lettres, le système d'écriture, le clavier, les notes et les sons. Sa sauvegarde aussi. Elle est retirée de votre compte, elle ne reviendra donc pas sur un autre téléphone. Vos autres langues, vos publications et votre compte restent. Ceci est irréversible.",
      "langs.title"      : "Langues",
