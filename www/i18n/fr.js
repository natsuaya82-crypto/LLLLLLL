...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.draw.h"                 : "Dessinez la première lettre<br>de votre langue.",
      ...
      "ob.snd.h"                  : "Quel son fait-elle ?",
      "ob.snd.note.borrow"        : "Des formes empruntées, vos sons. Rien ici n’est tenu de signifier ce que cela signifie là où vous l’avez trouvé.",
      "ob.snd.note.draw"          : "La lettre rejoint votre alphabet et le son rejoint votre inventaire.",
      "ob.enter"                  : "Commencer",
      ...
      "word.note"        : "{0} syllabes. Au-dessus, le mot lui-même, dans les sons que vous avez choisis.<br>À côté de chaque syllabe, la lecture approchée pour qui lit {1} ({2}) ; le bouton la dit.",
      "word.note.1"      : "Une syllabe. Au-dessus, le mot lui-même, dans les sons que vous avez choisis.<br>À côté, la lecture approchée pour qui lit {1} ({2}) ; le bouton la dit.",
      "word.edit"        : "Modifier",
