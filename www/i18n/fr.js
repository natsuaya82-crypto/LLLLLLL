...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "snd.empty" : "Pas encore de sons",
      "snd.nolt" : "aucune lettre ne le dit",
      ...
      "fmr.what"         : "Écrivez une fois comment une forme se fait, et n'importe quel mot pourra donner les formes qu'il n'a pas encore. Rien n'est créé avant que vous le demandiez, et ce qui sort est un mot ordinaire : modifiez-le, supprimez-le, ou écrivez vous-même une forme irrégulière.",
      ...
      "confirm.wipe"     : "Tout effacer sur ce téléphone et se déconnecter ? La langue, les lettres et les réglages disparaissent, et c'est sans retour.",
      "langs.title"      : "Langues",
      ...
      "plan.studio.1"    : "Tout ce que contient Plus",
      "plan.studio.2"    : "Travailler avec une IA : un mot à partir d'un sens, la grammaire, des exemples",
      "plan.studio.3"    : "Des suggestions sans limite quotidienne",
      "plan.price.free"  : "0 $",
