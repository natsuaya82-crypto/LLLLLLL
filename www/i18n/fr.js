...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "cap.hid"                   : "{0} mots de plus sont ici, et dans votre sauvegarde",
      "cap.lapse.h"               : "Votre forfait a pris fin",
      "cap.lapse.d"               : "Lingua est revenu au forfait Gratuit : le dictionnaire affiche les 100 premiers mots et l’écriture redevient un alphabet. <b>Rien n’a été supprimé.</b> Tous vos mots, vos lettres et votre clavier sont toujours là et toujours dans votre sauvegarde, et tout revient dès que vous vous réabonnez.",
      "cap.lapse.ok"              : "J’ai compris",
      ...
      "dir.ttb-rl"    : "Vers le bas, colonnes de droite à gauche",
      "dir.ttb-lr"    : "Vers le bas, colonnes de gauche à droite",
      "dir.locked"    : "Choisir le sens de votre langue",
      "lt.name"          : "Nom",
      "lt.name.ph"       : "p. ex. esh",
