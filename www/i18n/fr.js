...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.mail.to.forgot" : "J’ai oublié mon mot de passe",
      "ob.signin.or" : "ou",
      "ob.bar.up.q" : "Vous n'avez pas de compte ?",
      "ob.bar.up.a" : "Inscrivez-vous",
      "ob.bar.in.q" : "Vous avez déjà un compte ?",
      "ob.bar.in.a" : "Connectez-vous",
