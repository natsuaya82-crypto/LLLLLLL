...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.sns.2.m" : "J'ai inventé un mot pour l'odeur de la pluie.",
      "ob.sns.3.n" : "Sela",
      "ob.sns.3.h" : "sela",
      "ob.sns.3.l" : "arun teva mi kastel, ova neri sa.",
      "ob.sns.3.m" : "Trois mois et j'écris une phrase entière.",
      "ob.sns.4.n" : "Kai",
      "ob.sns.4.h" : "kai",
      "ob.sns.4.l" : "mel korva anta ve losin.",
      "ob.sns.4.m" : "Mon clavier marche sur mon téléphone.",
      "ob.sns.5.n" : "Nuri",
      "ob.sns.5.h" : "nuri",
      "ob.sns.5.l" : "tavel esko rin, ilma korsa te.",
      "ob.sns.5.m" : "Système de numération fini. Base douze.",
      "ob.sns.6.n" : "Erim",
      "ob.sns.6.h" : "erim",
      "ob.sns.6.l" : "vasta lome ker un sadi, terin ova.",
      "ob.sns.6.m" : "Six cents mots. Ça sonne comme une langue.",
      "ob.tour.row.letters" : "Touchez Lettres.",
      "ob.tour.row.gram" : "Touchez Grammaire.",
      "ob.tour.letters" : "Vos lettres.",
      "ob.tour.gram" : "Votre grammaire.",
