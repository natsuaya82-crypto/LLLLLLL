...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "hp.lt.out.d" : "La marque de partage en haut à droite. Police crée un fichier de police de toutes les lettres dessinées, à utiliser dans d'autres apps. SVG crée une seule image de toutes, un carré chacune.",
      "hp.lt.wr.d" : "Écrivez vos lettres sur une feuille, sur le téléphone ou sur papier, puis ramenez-la. Son ? donne les étapes.",
      "hp.lt.ab.d" : "Quand la langue est un abugida ou s'écrit en blocs, une ligne en haut ouvre la place des voyelles.",
      ...
      "hp.bk.1" : "Touchez une voyelle",
      "hp.bk.1.d" : "Chaque voyelle décide comment son carré est découpé.",
      "hp.bk.2" : "Choisissez le découpage",
      "hp.bk.2.d" : "Côte à côte met la voyelle à droite de la consonne ; haut et bas la met dessous.",
      "hp.bk.3" : "Finales",
      "hp.bk.3.d" : "Une syllabe avec consonne finale reçoit une rangée de plus en bas de son carré.",
