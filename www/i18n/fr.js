...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "wr.say.build"     : "Feuille construite — {0} octets",
      "wr.say.build.no"  : "Feuille non construite — les noms ne tiennent pas dans la bande",
      "wr.say.b64"       : "Encodée — {0} caractères",
      "wr.say.b64.no"    : "L’encodage a échoué — {0}",
      "wr.say.nobridge"  : "Aucun endroit où la déposer",
      "wr.say.sent"      : "Remise au téléphone",
      "wr.say.filed"     : "Enregistrée sous {0}",
      "wr.say.have"      : "Dans Sheets — {0} fichiers, le plus récent {1}",
      "wr.say.have.none" : "Dans Sheets — il n’y a rien",
      "wr.say.have.no"   : "Impossible de regarder dans Sheets — {0}",
      "wr.say.unnamed"   : "Le téléphone a répondu sans nom de fichier",
      "wr.say.refused"   : "Le téléphone a refusé — {0}",
      "wr.say.got"       : "Fichier — {0} octets",
      "wr.say.kind"      : "Contenu — {0}",
      "wr.say.jpeg"      : "Photo à l’intérieur — {0} octets",
      "wr.say.jpeg.no"   : "Aucune photo à l’intérieur",
      "wr.say.draw"      : "Demandé au téléphone de dessiner la page",
      "wr.say.drew"      : "Le téléphone l’a dessinée — {0} caractères",
      "wr.say.drew.no"   : "Le téléphone n’a rien dessiné",
      "wr.say.read"      : "Lu — {0} noms, {1} avec de l’encre",
