...
defLang('fr', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.sns.1.n" : "Mara",
      "ob.sns.1.h" : "mara",
      "ob.sns.1.l" : "Alphabet terminé aujourd'hui. Vingt-huit lettres.",
      "ob.sns.2.n" : "Thomas",
      "ob.sns.2.h" : "tomas",
      "ob.sns.2.l" : "J'ai inventé un mot pour l'odeur de la pluie.",
      "ob.sns.3.n" : "Inès",
      "ob.sns.3.h" : "ines",
      "ob.sns.3.l" : "Trois mois et j'écris une phrase entière.",
      "ob.sns.4.n" : "Kai",
      "ob.sns.4.h" : "kai",
      "ob.sns.4.l" : "Mon clavier marche sur mon téléphone.",
      "ob.sns.5.n" : "Nour",
      "ob.sns.5.h" : "noor",
      "ob.sns.5.l" : "Système de numération fini. Base douze.",
      "ob.sns.6.n" : "Élias",
      "ob.sns.6.h" : "elias",
      "ob.sns.6.l" : "Six cents mots. Ça sonne comme une langue.",
      "ob.tour.row.letters" : "Touchez Lettres.",
      "ob.tour.row.words" : "Touchez Lexique.",
      "ob.tour.row.gram" : "Touchez Grammaire.",
      "ob.tour.letters" : "Vos lettres.",
      "ob.tour.words" : "Vos mots.",
