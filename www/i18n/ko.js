...
defLang('ko', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ask.word.ask" : "이 언어의 단어를 많이 만들고 싶습니다. 진행 방식은 맡기겠습니다 — 묻고 싶은 게 있으면 물어보고, 아니라고 생각하면 말해 주고, 제가 생각하지 못한 방향도 좋습니다. 형식만 하나 부탁드립니다: 목록은 코드 블록으로, 한 줄에 한 단어, 단어와 뜻을 탭으로 구분해 주세요. 그대로 앱에 다시 붙여 넣을 거라서요.",
      "words.more" : "더 보기",
      "words.search"     : "검색",
      "words.clear"      : "지우기",
      "words.sort.a"     : "소리순",
      ...
      "wr.out"           : "용지 내보내기",
      "wr.out.ok"        : "내보냈습니다",
      "wr.say.build"     : "용지를 만들었습니다 — {0}바이트",
      "wr.say.build.no"  : "용지를 만들지 못했습니다 — 이름이 띠에 들어가지 않습니다",
      "wr.say.b64"       : "부호화했습니다 — {0}자",
      "wr.say.b64.no"    : "부호화가 실패했습니다 — {0}",
      "wr.say.nobridge"  : "넣을 곳이 없습니다",
      "wr.say.sent"      : "전화기에 넘겼습니다",
      "wr.say.filed"     : "{0}(으)로 저장되었습니다",
      "wr.say.have"      : "Sheets 안 — {0}개, 가장 새것은 {1}",
      "wr.say.have.none" : "Sheets 안 — 아무것도 없습니다",
      "wr.say.have.no"   : "Sheets 안을 볼 수 없습니다 — {0}",
      "wr.say.unnamed"   : "전화기가 답했지만 파일 이름이 없습니다",
      "wr.say.refused"   : "전화기가 거절했습니다 — {0}",
      "wr.say.got"       : "파일 — {0}바이트",
      "wr.say.kind"      : "안에 든 것 — {0}",
      "wr.say.jpeg"      : "안에 사진 — {0}바이트",
      "wr.say.jpeg.no"   : "안에 사진이 없습니다",
      "wr.say.draw"      : "전화기에 페이지를 그리도록 했습니다",
      "wr.say.drew"      : "전화기가 그렸습니다 — {0}자",
      "wr.say.drew.no"   : "전화기가 아무것도 그리지 않았습니다",
      "wr.say.read"      : "읽었습니다 — 이름 {0}개, 그중 {1}개에 잉크",
