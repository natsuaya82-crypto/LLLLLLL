...
defLang('ko', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.sns.2.m" : "비 온 뒤 냄새를 뜻하는 단어를 만들었어요.",
      "ob.sns.3.n" : "Sela",
      "ob.sns.3.h" : "sela",
      "ob.sns.3.l" : "arun teva mi kastel, ova neri sa.",
      "ob.sns.3.m" : "석 달 만에 한 문장을 통째로 씁니다.",
      "ob.sns.4.n" : "Kai",
      "ob.sns.4.h" : "kai",
      "ob.sns.4.l" : "mel korva anta ve losin.",
      "ob.sns.4.m" : "키보드가 드디어 폰에서 돌아가요.",
      "ob.sns.5.n" : "Nuri",
      "ob.sns.5.h" : "nuri",
      "ob.sns.5.l" : "tavel esko rin, ilma korsa te.",
      "ob.sns.5.m" : "수 체계 완성. 십이진법입니다.",
      "ob.sns.6.n" : "Erim",
      "ob.sns.6.h" : "erim",
      "ob.sns.6.l" : "vasta lome ker un sadi, terin ova.",
      "ob.sns.6.m" : "육백 단어. 이제 언어처럼 들려요.",
      "ob.tour.row.letters" : "글자를 누르세요.",
      "ob.tour.row.gram" : "문법을 누르세요.",
