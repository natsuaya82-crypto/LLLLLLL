...
defLang('ko', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "plan.studio.1"    : "Plus 의 전부",
      "plan.studio.2"    : "AI 와 함께: 뜻에서 낱말, 문법, 예문",
      "plan.studio.3"    : "제안에 하루 한도 없음",
      "plan.price.free"  : "$0",
      "plan.plus.6"  : "소리와 문법 단계와 쓰는 방향을 직접 정하기",
      "plan.plus.5"  : "목록을 파일로 들여오고 내보내기",
      "plan.plus.4"  : "단어 수 제한 없음",
      "plan.each.studio"  : "$16.67",
      "plan.each.plus"  : "$8.33",
      "plan.price.studio.yr"  : "$199.99",
