...
defLang('ko', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.sns.1.n" : "마라",
      "ob.sns.1.h" : "mara",
      "ob.sns.1.l" : "오늘 글자를 다 그렸어요. 스물여덟 개.",
      "ob.sns.2.n" : "토마",
      "ob.sns.2.h" : "tomas",
      "ob.sns.2.l" : "비 온 뒤 냄새를 뜻하는 단어를 만들었어요.",
      "ob.sns.3.n" : "이네",
      "ob.sns.3.h" : "ines",
      "ob.sns.3.l" : "석 달 만에 한 문장을 통째로 씁니다.",
      "ob.sns.4.n" : "카이",
      "ob.sns.4.h" : "kai",
      "ob.sns.4.l" : "키보드가 드디어 폰에서 돌아가요.",
      "ob.sns.5.n" : "누르",
      "ob.sns.5.h" : "noor",
      "ob.sns.5.l" : "수 체계 완성. 십이진법입니다.",
      "ob.sns.6.n" : "엘리",
      "ob.sns.6.h" : "elias",
      "ob.sns.6.l" : "육백 단어. 이제 언어처럼 들려요.",
      "ob.tour.row.letters" : "글자를 누르세요.",
      "ob.tour.row.words" : "어휘를 누르세요.",
      "ob.tour.row.gram" : "문법을 누르세요.",
      "ob.tour.letters" : "당신의 글자.",
      "ob.tour.words" : "당신의 단어.",
      "ob.tour.gram" : "당신의 문법.",
