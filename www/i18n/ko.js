...
defLang('ko', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "find.back"        : "뒤로",
      "snd.add" : "소리 추가",
      "snd.empty" : "아직 소리가 없습니다",
      "snd.nolt" : "이 소리를 읽는 글자가 없습니다",
      "snd.drop" : "이 소리 삭제",
      ...
      "fmr.what"         : "형태를 어떻게 만드는지 한 번 적어 두면, 어떤 낱말에서든 아직 없는 형태를 만들 수 있습니다. 누르기 전에는 아무것도 생기지 않고, 나오는 것은 보통 낱말이라 고치거나 지울 수 있으며 불규칙한 것은 직접 쓰면 됩니다.",
      "fmr.new"          : "규칙 쓰기",
      "fmr.any"          : "모든 낱말",
      "fmr.pos"          : "적용할 낱말",
      "fmr.fm"           : "만드는 형태",
      ...
      "set.wipe"         : "이 기기의 데이터 지우기",
      "set.drop"         : "계정 삭제",
      "set.drop.done"    : "계정을 삭제했습니다",
      "confirm.drop"     : "계정을 삭제할까요? 서버에 있는 게시물과 사진, 녹음이 사라지며 되돌릴 수 없습니다. 이 기기의 언어는 그대로 남습니다.",
      "confirm.wipe"     : "이 휴대폰의 모든 것을 지우고 로그아웃할까요? 언어와 글자와 설정이 모두 사라지고, 되돌릴 수 없습니다.",
      "langs.title"      : "언어",
      "langs.mine"       : "내 언어",
      "langs.reading"    : "읽는 중",
      ...
      "plan.plus.2"      : "음절문자, 아브자드, 아부기다, 표어문자",
      "plan.plus.3"      : "직접 짜는 키보드 세 개까지",
      "plan.price.free"  : "$0",
      "plan.plus.6"  : "소리와 문법 단계와 쓰는 방향을 직접 정하기",
      "plan.plus.5"  : "목록을 파일로 들여오고 내보내기",
      "plan.plus.4"  : "단어 수 제한 없음",
      "plan.each.plus"  : "$8.33",
      "plan.price.plus.yr"  : "$99.99",
      "plan.each"  : "월 {0}, 1년에 한 번 결제",
      "plan.per.yr"  : "／년",
      "plan.per.mo"  : "／월",
      "plan.save"  : "2개월 무료",
      "plan.term.yr"  : "연간",
      ...
      "mod.out"            : "@{0} 정지",
      "mod.in"             : "@{0} 해제",
      "mod.out.sure"       : "이 계정을 정지할까요? 쓴 것은 그대로 남고 읽을 수도 있지만, 해제할 때까지 게시·답글·반응을 할 수 없습니다.",
      "post.out"           : "이 계정은 정지되었습니다. 읽을 수는 있지만 쓴 것은 올라가지 않습니다.",
      "post.down"          : "이 게시물은 내려졌습니다. 다른 사람에게는 보이지 않습니다.",
      "post.pin"        : "이 글을 고정",
      "post.unpin"        : "고정 해제",
      "post.pinned"        : "고정됨",
      "post.pic"        : "사진",
