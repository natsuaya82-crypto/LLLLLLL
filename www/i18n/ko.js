...
defLang('ko', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "hp.lt.out.d" : "오른쪽 위의 공유 표시입니다. 폰트는 그린 글자 전부로 다른 앱에서 쓸 수 있는 폰트 파일을 만듭니다. SVG는 전부를 한 장의 그림으로, 글자마다 한 칸씩 만듭니다.",
      "hp.lt.wr.d" : "종이 한 장에 글자를 써서 — 휴대폰에서든 종이에든 — 다시 가져옵니다. 순서는 그 화면의 ?에 있습니다.",
      "hp.lt.ab.d" : "언어가 아부기다이거나 조합해서 쓰는 방식이면, 맨 위의 줄에서 모음이 어디에 놓이는지 엽니다.",
      ...
      "hp.bk.1" : "모음을 누릅니다",
      "hp.bk.1.d" : "모음마다 칸을 나누는 방법이 정해집니다.",
      "hp.bk.2" : "나누는 방법을 고릅니다",
      "hp.bk.2.d" : "좌우는 모음을 자음 오른쪽에, 상하는 자음 아래에 놓습니다.",
      "hp.bk.3" : "받침",
      "hp.bk.3.d" : "받침이 있는 음절은 칸 아래에 한 줄이 더 붙습니다.",
