...
defLang('ko', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "cap.lapse.d"               : "만든 것은 하나도 지워지지 않았습니다. 단어도 문자도 키보드도 문법도 게시물도 모두 그대로 계정에 남아 있습니다.<br><br>무료 플랜에서는 사전에 표시되는 것이 100개까지, 키보드는 1개, 언어는 1개가 됩니다. 101번째 단어부터는 사라진 것이 아니라 표시되지 않을 뿐입니다.<br><br>다시 업그레이드하면 모두 그대로 돌아옵니다.",
      "cap.lapse.ok"              : "닫기",
      "ch.clear"                  : "글자 없음",
      "ch.for"                    : "“{0}”의 글자",
      "ob.back"                   : "뒤로",
