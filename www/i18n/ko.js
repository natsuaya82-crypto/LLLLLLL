...
defLang('ko', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "wld.ask"      : "무엇을 위한 언어입니까",
      "wld.use"      : "무엇을 위해",
      "wld.story"    : "이야기",
      "wld.story.d"  : "책·영화·게임 속의 누군가가 씁니다.",
      "wld.people"   : "겨레",
      "wld.people.d" : "이 땅에 없는, 또는 있었던 사람들.",
      "wld.place"    : "땅",
      "wld.place.d"  : "골짜기 하나, 섬 하나, 도시 하나와 그곳의 말투.",
      "wld.real"     : "실제로 말하기",
      "wld.real.d"   : "정말 쓰려고 만든 것. 누군가와, 또는 혼자.",
      "wld.play"     : "알아보기",
      "wld.play.d"   : "언어가 이렇게 움직이면 어떻게 되는지 보려고.",
      "wld.where"    : "말해지는 곳",
      "wld.where.ph" : "북쪽 골짜기",
      "wld.who"      : "말하는 사람들",
      "wld.who.ph"   : "강가 사람들",
      ...
      "stg.ex.lb.ph"     : "",
      "stg.noun.t"       : "명사",
      "stg.noun.d"       : "둘 이상일 때와, 명사가 갖는 꼴.",
      "stg.verb.t"       : "동사",
      "stg.verb.d"       : "시제와, 동사가 바뀌면 무엇이 되는지.",
      "stg.neg.not"      : "아니다",
      "stg.ask.why"      : "왜",
      "stg.ask.how"      : "어떻게",
      "stg.conj.t"       : "잇기",
      "stg.conj.d"       : "그리고, 또는, 그러나 — 그리고 한 문장을 다른 문장에 거는 말.",
      "stg.conj.and"     : "그리고",
      "stg.conj.or"      : "또는",
      "stg.conj.but"     : "그러나",
      ...
      "stg.conj.then"    : "그러면",
      "stg.part.t"       : "조사",
      "stg.part.d"       : "한 낱말이 문장에서 무엇을 하는지 나타내는 작은 말.",
      "stg.polite.t"     : "높임",
      "stg.polite.d"     : "조심해서 말할 때 이 언어가 어떻게 달라지는지.",
      "stg.where.t"      : "자리",
      "stg.where.in"     : "안에",
      "stg.where.on"     : "위에",
      "stg.where.under"  : "아래에",
      ...
      "stg.where.from"   : "에서",
      "stg.where.with"   : "와",
      "stg.where.d"      : "물건이 어디 있는지, 어디로 가는지.",
      "stg.when.t"       : "때",
      "stg.when.now"     : "지금",
      "stg.when.before"  : "전",
      "stg.when.after"   : "후",
