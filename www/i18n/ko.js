...
defLang('ko', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "cap.lapse.d"               : "사라진 것은 없습니다. 단어, 글자, 키보드, 게시물 모두 계정에 그대로 남아 있습니다.<br><br>무료 플랜에서는 사전의 처음 100개 단어, 키보드 1개, 언어 1개만 보입니다. 나머지는 숨겨져 있을 뿐, 지워진 것이 아닙니다.<br><br>다시 업그레이드하면 모두 그대로 돌아옵니다.",
      "cap.lapse.ok"              : "닫기",
      "ch.clear"                  : "글자 없음",
      "ch.for"                    : "“{0}”의 글자",
      "ob.back"                   : "뒤로",
