...
defLang('ko', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "post.likers"     : "좋아한 사람",
      "post.boosters"   : "리포스트한 사람",
      "post.likers.none" : "아직 좋아한 사람이 없습니다.",
      "post.boosters.none" : "아직 리포스트한 사람이 없습니다.",
      "pop.undo"        : "해제",
      "post.unboost.q"  : "리포스트를 해제할까요?",
      "me.unfollow.q"   : "@{0} 님 팔로우를 해제할까요?",
      "post.del.ok"     : "게시글을 삭제했습니다",
      "post.del.no"     : "게시글을 삭제하지 못했습니다",
      "lang.del.no"     : "언어를 삭제하지 못했습니다",
      "when.now"        : "방금",
      "when.m"          : "{0}분",
      "when.h"          : "{0}시간",
      "when.d"          : "{0}일",
      ...
      "g2.g.person" : "인칭",
      "g2.g.tense"  : "시제",
      "g2.g.mood"   : "명령・조건・가능・해야 한다・하고 싶다",
      "g2.g.voice"  : "피동・사동",
      "g2.g.degree" : "비교",
      "g2.book.snt.t"   : "문장",
      "g2.book.noun.t"  : "명사",
      ...
      "g2.book.num.t"   : "수사",
      "g2.book.verb.t"  : "동사",
      "g2.book.mod.t"   : "형용사와 부사",
      "g2.book.pp.t"    : "전치사・후치사",
      "g2.book.sub.t"   : "복문",
      "g2.book.wf.t"    : "조어",
      "g2.book.app.t"   : "부록",
      "g2.on.v"        : "동사 문장",
      ...
      "g2.q.b"        : "의문문",
      "g2.pol.pick"        : "낱말 넣기",
      "g2.pol.own"        : "사전에 없는 낱말",
      "g2.pol.at.before"        : "{0} 이 동사 앞",
      "g2.pol.at.after"        : "{0} 이 동사 뒤",
      "g2.pol.at.head"        : "{0} 이 문장 앞",
      "g2.pol.at.tail"        : "{0} 이 문장 끝",
      "g2.pol.order"        : "어순이 {0}",
      "g2.pol.and"        : "와 ",
      "gram.pos.before.main" : "주절 앞",
      "gram.pos.after.main" : "주절 뒤",
      "gram.pos.before.cl" : "안쪽 문장 앞",
      "gram.pos.after.cl" : "안쪽 문장 뒤",
      "stg.part.t"       : "조사",
      ...
      "stg.part.inst"    : "무엇으로",
      "stg.part.com"     : "함께",
      "gram.eg.poss"     : "<b>친구의</b> 책",
      "gram.eg.loc"      : "나는 <b>산에서</b> 읽는다",
      "gram.eg.inst"     : "나는 <b>펜으로</b> 쓴다",
      "gram.eg.com"      : "나는 <b>친구와</b> 간다",
      "stg.polite.t"     : "높임",
      ...
      "ws.k.block" : "모아쓰기",
      "ws.k.block.d" : "글자를 한 칸에",
      "ws.k.block.eg" : "글자를 모아 한 칸에 — 한글: 한 은 ㅎ ㅏ ㄴ",
      "blk.title" : "칸",
      "blk.lr" : "좌우",
      "blk.tb" : "상하",
      "lt.out" : "내보내기",
      ...
      "g2.rule.when.v"      : "모음 뒤일 때, ",
      "g2.rule.when.c"      : "자음 뒤일 때, ",
      "g2.rule.when.x"      : "{0}(으)로 끝날 때, ",
      "g2.rule.drop"      : "끝에서 {0}자를 떼고, ",
      "fmr.end"          : "뒤에",
      "fmr.start"        : "앞에",
      "fmr.sel" : "선택",
      "fmr.sel.done" : "완료",
      ...
      "contact.send" : "보내기",
      "contact.sent" : "보냈습니다",
      "contact.need" : "내용을 입력해 주세요.",
      "set.pw.old"         : "현재 비밀번호",
      "set.mail"         : "이메일",
      "set.pw.go"         : "변경",
      "set.pw.done"         : "비밀번호를 변경했습니다",
      "net.needpw"         : "둘 다 입력해 주세요.",
      "confirm.wipe"     : "모든 데이터를 삭제할까요? 계정과 서버의 모든 게시물·사진·녹음이 사라지고, 이 기기의 모든 언어·문자·설정도 사라집니다. 되돌릴 수 없습니다. 구독을 해지한 뒤 계정을 삭제해 주세요.",
      "confirm.wipe.langs": "{0}을(를) 삭제할까요? 여기서 만든 것이 모두 사라집니다 — 단어, 글자, 문자 체계, 키보드, 메모, 소리. 계정에서도 지워지므로 다른 기기에서도 돌아오지 않습니다. 다른 언어와 게시물, 계정은 남습니다. 되돌릴 수 없습니다.",
      "langs.title"      : "언어",
      "langs.mine"       : "내 언어",
      "langs.reading"    : "읽는 중",
      ...
      "plan.free.5" : "키보드를 자유롭게 — 내 글자든 어떤 문자든",
      ...
      "f.sub.d.adj.qual" : "성질",
      "f.sub.d.adj.stat" : "상태",
      "f.sub.d.adj.quant" : "수량",
      "f.sub.d.adv.man" : "양태",
      "f.sub.d.adv.deg" : "정도",
      "f.sub.d.adv.time" : "시간",
      "f.sub.d.adv.place" : "장소",
      "f.sub.d.adv.freq" : "빈도",
      "f.sub.d.pro.pers" : "인칭",
      "f.sub.d.pro.dem" : "지시",
      "f.sub.d.pro.int" : "의문",
      "f.sub.d.pro.indef" : "부정",
      "f.sub.d.num.card" : "기수",
      "f.sub.d.num.ord" : "서수",
      "f.sub.d.conj.co" : "등위",
      "f.sub.d.conj.sub" : "종속",
      "f.sub.d.part.case" : "격조사",
      "f.sub.d.part.fin" : "종결조사",
      "f.sub.d.part.top" : "보조사",
      "add.btn"          : "담기",
      ...
      "word.fm.plp.d"        : "과거의 어느 때보다 먼저 끝난 일",
      "word.fm.prf.e"        : "걷다 → 걸어 버렸다",
      "word.fm.plp.e"        : "걷다 → 걸었었다",
      ...
      "word.fm.p1s.d"       : "나가 할 때 동사가 취하는 형",
      "word.fm.p1s.e"       : "가다 → 내가 간다",
      "word.fm.p2s.d"       : "너가 할 때 동사가 취하는 형",
      "word.fm.p2s.e"       : "가다 → 네가 간다",
      "word.fm.p3s.d"       : "그 또는 그녀가 할 때 동사가 취하는 형",
      "word.fm.p3s.e"       : "가다 → 그가 간다",
      "word.fm.p1p.d"       : "우리가 할 때 동사가 취하는 형",
      "word.fm.p1p.e"       : "가다 → 우리가 간다",
      "word.fm.p2p.d"       : "너희가 할 때 동사가 취하는 형",
      "word.fm.p2p.e"       : "가다 → 너희가 간다",
      "word.fm.p3p.d"       : "그들가 할 때 동사가 취하는 형",
      "word.fm.p3p.e"       : "가다 → 그들이 간다",
      "word.fm.pot.d"      : "할 수 있다는 것",
      "word.fm.pot.e"      : "가다 → 갈 수 있다",
      "word.fm.obl.d"      : "해야 한다는 것",
      "word.fm.obl.e"      : "가다 → 가야 한다",
      "word.fm.des.d"      : "하고 싶다는 것",
      "word.fm.des.e"      : "가다 → 가고 싶다",
      "word.fm.cmp.d"     : "둘을 비교하는 형",
      "word.fm.cmp.e"     : "크다 → 더 크다",
      "word.fm.sup.d"     : "가장이라는 형",
      "word.fm.sup.e"     : "크다 → 가장 크다",
      ...
      "wfm.label"          : "라벨",
      "wfm.form"           : "형태",
      "wfm.need"           : "형태에는 라벨과 철자가 모두 필요합니다",
      "wfm.del"            : "이 형태 삭제",
      "word.derive"      : "파생어 만들기",
      "word.note"        : "메모",
      "word.sp"          : "읽기",
      ...
      "word.from" : "유래어",
      "word.from.add" : "유래어 고르기",
      "ety.title" : "계통도",
      "gen.title" : "단어 만들기",
      "gen.door" : "만들기",
      "gen.syl" : "음절 구조",
      "gen.again" : "다시",
      "gen.none" : "아직 단어를 만들 수 없습니다",
      "gen.c" : "C",
      "gen.v" : "V",
      "word.ant"         : "반대 뜻의 단어",
      ...
      "csv.title"        : "목록 가져오기",
      "csv.ph"           : "고양이\n물\n걷다\n\nkano, 산, 명사",
      "csv.full"        : "{0}개 가져옴, {1}개 만듦 — 목록이 가득 찼습니다",
