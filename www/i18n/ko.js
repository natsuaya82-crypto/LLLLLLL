...
defLang('ko', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "find.ph"          : "이 언어 안에서 찾기",
      "find.mine.h"      : "만든 것 전부",
      "find.mine.d"      : "철자·뜻·읽기 — 언어의 어디에서든.",
      "find.world.h"     : "다른 사람의 언어",
      "find.world.d"     : "아직 열지 않았습니다. 열리면 여기에 나옵니다.",
      "toc.sound"        : "음운",
      "toc.letters"      : "문자",
      "ab.title"         : "모음 작업대",
      "ab.d"             : "아부기다에서 한 글자는 자음에 모음 부호를 얹은 것입니다. 그래서 맞아야 하는 것은 그림 하나가 아니라, 그 부호가 모든 자음 위에 어떻게 얹히는지입니다. 여기서 부호를 바꾸면 전부 같이 바뀝니다.",
      "ab.mark"          : "{0} 의 부호",
      "ab.every"         : "{0} 를 얹은 자음 전부",
      "ab.cell"          : "부호를 어떻게 옮겨도 맞지 않는 조합은 눌러서 그 글자만 그릴 수 있습니다.",
      "ab.left"          : "왼쪽으로",
      "ab.right"         : "오른쪽으로",
      "ab.up"            : "위로",
      "ab.down"          : "아래로",
      ...
      "ab.smaller"       : "작게",
      "ab.draw"          : "부호 그리기",
      "ab.nomark"        : "이 모음의 부호는 아직 그리지 않았습니다.",
      "ab.nocons"        : "자음이 아직 없습니다.",
      "ab.novow"         : "모음이 아직 없습니다.",
      "ab.notabugida"    : "이 언어는 아부기다로 쓰지 않습니다.",
      "lt.note"          : "문자와 소리는 같은 것이 아닙니다. 한 소리를 두 가지로 쓸 수도 있고, 한 문자가 두 가지로 읽힐 수도 있고, 무엇을 나타낼지 정하기 전에 문자만 먼저 만들 수도 있습니다.",
      "lt.all"           : "문자 전부",
      "lt.none"          : "아직 문자가 없습니다.",
      "lt.new"           : "새 문자",
      "lt.untitled"      : "이름 없음",
      "lt.draw"          : "문자 그리기",
      "lt.use"           : "이미 있는 문자 쓰기",
      "lt.use.d"         : "{0} 을(를) 어떤 문자로 쓸지. 소리 하나에 여럿이어도 됩니다.",
      "lt.addsnd"        : "읽는 것",
      "lt.addsnd.d"      : "이 문자에 이름을 붙이고, 어떤 소리를 읽는지 정합니다. 없어도, 여럿이어도 됩니다.",
      "lt.reads"         : "{0} 을(를) 읽음",
      "lt.reads.none"    : "아직 아무것도 읽지 않음",
      "lt.reads.h"       : "이 문자가 읽는 소리",
      "lt.name"          : "이름",
      "lt.name.ph"       : "예: 에시",
      ...
      "as.soft"         : "부드러운 소리",
      "as.soft.d"       : "비음과 ㄹ, 평범한 모음. 일본어나 이탈리아어에 가까워요.",
      "as.hard"         : "단단한 소리",
      "as.hard.d"       : "터지는 소리와 쉿 소리, 모음은 적게. 조지아어나 러시아어에 가까워요.",
      "as.flowing"      : "흐르는 소리",
      "as.flowing.d"    : "울리는 소리가 대부분, 모음은 다섯. 날카로운 소리는 거의 없어요.",
      "as.breathy"      : "숨이 섞인 소리",
      "as.breathy.d"    : "스치는 소리와 ㅎ. 아랍어나 독일어에 가까워요.",
      "as.plain"        : "소박한 소리",
      "as.plain.d"      : "수가 적고 발음하기 쉬워요. 하와이어에 가까워요.",
      "as.hear"         : "모두 들어 보기",
      "as.again"        : "다른 조합",
      "as.own"          : "직접 고르기",
      "as.drop"         : "이 소리 빼기",
      ...
      "stg.list.d"       : "문법은 단계를 따라 세워요. 단계마다 거기 필요한 낱말과, 거기서 정할 것과, 다 하고 나면 말할 수 있는 한 줄이 들어 있어요.",
      "stg.words"        : "이 단계에 필요한 낱말",
      "stg.decide"       : "정할 것",
      "stg.note"         : "이 단계의 메모",
      "stg.note.ph"      : "문법의 이 부분에 대해 적어 둘 것.",
      "stg.line"         : "이제 말할 수 있는 것",
      "stg.make"         : "지어 보기",
      "stg.make.d"       : "소리를 탭하거나, 제안 중에서 하나를 골라요.",
      "stg.keep"         : "이 낱말 남기기",
      "stg.drop"         : "이 낱말 지우기",
      "stg.help"         : "낱말 제안받기",
      "stg.help.d"       : "이 언어가 가진 소리로 지어요.",
      "stg.again"        : "다른 제안",
      "stg.own.add.btn"  : "직접 단계 더하기",
      "stg.own.hint"     : "높임말, 친족을 부르는 말, 방향 — 이 언어에 필요해지는 것은 무엇이든 더할 수 있어요. 개수에 제한은 없어요.",
      "stg.own.h"        : "직접 만드는 단계",
      "stg.own.d"        : "이름을 정하고, 필요한 낱말을 한 줄에 하나씩 적어요.",
      "stg.own.title"    : "단계의 이름",
      "stg.own.title.ph" : "예: 높임말",
      "stg.own.words"    : "필요한 낱말",
      "stg.own.words.ph" : "한 줄에 하나씩\n비워 두어도 괜찮아요",
      "stg.own.add"      : "더하기",
      "stg.own.need"     : "단계의 이름을 적어 주세요.",
      "stg.own.added"    : "{0} 더했어요",
      "stg.own.untitled" : "이름 없는 단계",
      "stg.own.del"      : "이 단계 지우기",
      "stg.own.del.ask"  : "이 단계를 지울까요? 안에 있던 낱말은 어휘에 그대로 남아요.",
      /* the stages */
      "stg.greet.t"      : "네, 아니요, 안녕",
      "stg.greet.d"      : "가장 짧게 말할 수 있는 것들. 하나씩만 있어도 이 언어로 말할 수 있어요.",
      "stg.greet.yes"    : "네",
      "stg.greet.no"     : "아니요",
      ...
      "stg.pron.t"       : "나, 너, 그들",
      "stg.pron.d"       : "이것이 없으면 하는 쪽이 없어서, 어순이 아직 늘어놓을 것이 없어요.",
      "stg.pron.i"       : "나",
      "stg.pron.you"     : "너",
      "stg.pron.he"      : "그 / 그녀",
      "stg.pron.we"      : "우리",
      ...
      "stg.pron.they"    : "그들",
      "stg.order.t"      : "어순",
      "stg.order.d"      : "이제 하는 쪽이 생겼으니, 어디에 놓을지 정해요.",
      "stg.num.t"        : "하나보다 많을 때",
      "stg.num.d"        : "여럿이라는 것을 낱말이 나타내는지, 나타낸다면 어떻게 하는지예요.",
      "stg.time.t"       : "이미 일어난 일",
      "stg.time.d"       : "하는 일이 끝났을 때 그 낱말이 어떻게 달라지는지예요.",
      "stg.neg.t"        : "아니라고 하기",
      "stg.neg.d"        : "말한 것을 이 언어가 어떻게 뒤집는지예요.",
      "stg.ask.t"        : "묻기",
      "stg.ask.d"        : "말한 것을 묻는 것으로 바꾸는 표시와, 무엇을 묻는지 가리키는 낱말들.",
      "stg.ask.what"     : "무엇",
      "stg.ask.who"      : "누구",
      "stg.ask.where"    : "어디",
      "stg.ask.when"     : "언제",
      "stg.desc.t"       : "꾸미는 말",
      "stg.desc.d"       : "꾸미는 말이 어느 자리에 오는지예요.",
      "stg.have.t"       : "누구의 것",
      "stg.have.d"       : "하나가 다른 것의 것이라고 이 언어가 어떻게 말하는지예요.",
      "stg.count.t"      : "세기",
      "stg.count.d"      : "하나부터 열까지. 대개의 언어는 나머지를 이 열 개로 지어요.",
      /* the kinds of writing */
      "ws.kind"         : "글자 하나가 무엇을 나타내는지",
      "ws.k.alpha"      : "음소문자",
      "ws.k.alpha.d"    : "글자 하나가 소리 하나예요. 언어에 있는 소리마다 글자를 하나씩 그려요.",
      "ws.k.alpha.eg"   : "글자 하나에 소리 하나 — 한글이나 로마자처럼",
      "ws.k.syll"       : "음절문자",
      "ws.k.syll.d"     : "글자 하나가 음절 하나예요. 자음과 모음을 따로 적지 않아요.",
      "ws.k.syll.eg"    : "글자 하나에 음절 하나 — 일본 가나에서 ‘카’가 글자 하나인 것처럼",
      "ws.k.abjad"      : "아브자드",
      "ws.k.abjad.d"    : "자음만 적어요. 모음은 낱말에서 알 수 있으니 종이에는 남기지 않아요.",
      "ws.k.abjad.eg"   : "자음만 — 아랍 문자나 히브리 문자처럼",
      "ws.k.abugida"    : "아부기다",
      "ws.k.abugida.d"  : "자음에는 글자를, 모음에는 부호를 줘요. 둘 다 그리면 앱이 하나로 합쳐요.",
      "ws.k.abugida.eg" : "글자에 모음 부호를 붙인 모양 — 데바나가리나 타이 문자처럼",
      "ws.k.logo"       : "표어문자",
      "ws.k.logo.d"     : "글자 하나가 낱말 하나예요. 적는 낱말마다 그려야 할 글자가 하나씩 있어요.",
      ...
      /* onboarding */
      "ob.next"         : "다음",
      "ob.name.sub"     : "이것만큼은 이미 생각해 둔 게 있을 거예요.",
      "ob.name.note"    : "언제든 바꿀 수 있어요.",
      "ob.name.later"    : "나중에 정하기",
      "ob.ws.h"         : "어떻게 적나요?",
      "ob.ws.sub"       : "글자가 무엇인지를 여기서 정해요. 그래서 그리기보다 먼저예요.",
      "ob.ws.note"      : "나중에 바꿀 수 있고, 그려 둔 것은 그대로 남아요.",
      "ob.snds.h"       : "어떤 소리로 이루어져 있나요?",
      "ob.snds.sub"     : "몇 개만 골라요. 낱말은 여기서 고른 소리로 지어져요.",
      "ob.snds.n"       : "소리 {0}개 골랐어요",
      "ob.snds.note"    : "나중에는 한 번만 탭하면 온 표가 열려요 — 어느 언어가 쓰는 소리든 다 있어요.",
      "ob.snds.need"    : "소리를 적어도 하나 골라 주세요.",
      "ob.draw.h2"      : "{0}의 글자를 그려 보세요.",
      ...
      "word.uses"        : "쓰인 문장",
      "word.uses.none"   : "이 단어가 들어간 문장이 아직 없습니다.",
      "word.note"        : "메모",
      "word.note.d"      : "이 단어에 대해 기억해 두고 싶은 것. 어디에서 왔는지, 무엇과 헷갈리면 안 되는지.",
      "word.note.ph"     : "이 단어에 대한 아무거나",
      "word.syn"         : "같은 뜻의 단어",
      "word.syn.none"    : "아직 없습니다.",
      "word.syn.add"     : "같은 뜻의 단어 고르기",
      "word.syn.d"       : "{0} 와 같은 뜻인 단어를 고릅니다. 고르면 양쪽으로 이어집니다.",
      "word.ant"         : "반대 뜻의 단어",
      "word.ant.none"    : "아직 없습니다.",
      "word.ant.add"     : "반대 뜻의 단어 고르기",
      "word.ant.d"       : "{0} 와 반대 뜻인 단어를 고릅니다. 고르면 양쪽으로 이어집니다.",
      "word.ex"          : "예문",
      "word.ex.d"        : "이 언어의 한 문장과 그 뜻. 단어는 빈칸으로 나누어 씁니다. 사전에 있는 단어는 소리가 납니다.",
      "word.ex.ln.ph"    : "빈칸으로 나눈 단어",
      "word.ex.gl.ph"    : "그 뜻",
      "word.ex.del"      : "이 예문 지우기",
