...
defLang('ko', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "word.syl"         : "음절 나누기",
      "word.note"        : "{0}음절이에요. 위에 있는 건 낱말 그 자체, 당신이 고른 소리들이에요.<br>음절마다 그 옆에 {1} 사용자를 위한 어림 발음이 붙어요 ({2}). 단추를 누르면 소리로 들려줘요.",
      "word.note.1"      : "한 음절이에요. 위에 있는 건 낱말 그 자체, 당신이 고른 소리들이에요.<br>그 옆에 {1} 사용자를 위한 어림 발음이 붙어요 ({2}). 단추를 누르면 소리로 들려줘요.",
      "word.edit"        : "고치기",
