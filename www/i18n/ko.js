...
defLang('ko', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "hp.lt.ab.d" : "언어가 아부기다이면, 맨 위의 줄에서 모음이 어디에 놓이는지 엽니다.",
      ...
      "hp.bk.p" : "조합해서 쓰면 음절 하나가 한 칸입니다. 글자는 그린 자리에 그린 크기 그대로 놓이고, 음절의 글자들이 겹쳐서 조합됩니다.",
      "hp.bk.1" : "네 칸 중 한 곳에 그립니다",
      "hp.bk.1.d" : "그리는 칸은 넷으로 나뉘어 있습니다. 자음을 왼쪽 위에, 모음을 오른쪽 위에 그리면 음절에서 좌우로 나란히 놓입니다.",
      "hp.bk.2" : "받침",
      "hp.bk.2.d" : "위쪽 절반에 그린 받침은 반 칸 아래로 내려갑니다. 첫째는 왼쪽 아래, 둘째는 오른쪽 아래입니다.",
      "hp.bk.3" : "넷까지",
      "hp.bk.3.d" : "글자가 넷보다 많은 음절이나 받침이 셋 이상인 음절은 조합하지 않습니다.",
