...
defLang('ko', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ws.emoji" : "이모지",
      "hp.save" : "저장",
      "hp.save.d" : "오른쪽 위의 저장을 누르세요. 그 전에는 아무것도 바뀌지 않습니다.",
      "hp.lt.p" : "이 언어의 모든 글자가 여기 있습니다. 알파벳, 기호, 숫자 세 곳으로 나뉩니다.",
      "hp.lt.1" : "한 곳을 엽니다",
      "hp.lt.1.d" : "글자 하나가 칸 하나입니다. 누르면 그 글자의 페이지가 열립니다.",
      "hp.lt.2" : "그립니다",
      "hp.lt.2.d" : "글자 페이지에서 큰 글자를 누르고 손가락으로 그립니다.",
      "hp.lt.3" : "소리를 정합니다",
      "hp.lt.3.d" : "소리 줄을 누르면 소리표가 열립니다. 거기서 고른 것이 그 글자의 읽는 법입니다.",
      "hp.lt.out.d" : "오른쪽 위의 공유 표시로 내보내기 화면을 엽니다. 폰트는 그린 글자 전부로 다른 앱에서 쓸 수 있는 폰트 파일을 만듭니다. SVG는 전부를 한 장의 그림으로, 글자마다 한 칸씩 만듭니다.",
      "hp.lt.wr.d" : "종이 한 장에 글자를 써서 — 휴대폰에서든 종이에든 — 다시 가져옵니다. 순서는 그 화면의 ?에 있습니다.",
      "hp.lt.ab.d" : "언어가 아부기다이면, 맨 위의 줄에서 모음이 어디에 놓이는지 엽니다. 조합해서 쓰는 방식이면 배치는 모음 글자의 페이지에서 고릅니다.",
      "hp.ls.p" : "칸 하나가 글자 하나입니다.",
      "hp.ls.1" : "글자를 엽니다",
      "hp.ls.1.d" : "칸을 누릅니다.",
      "hp.ls.2" : "순서를 바꿉니다",
      "hp.ls.2.d" : "글자를 길게 누르세요. 칸이 흔들리기 시작하면 끌어서 옮기고, 모서리의 −를 눌러 빼고, 끝나면 오른쪽 위의 완료를 누릅니다.",
      "hp.ls.3" : "없는 글자를 그립니다",
      "hp.ls.3.d" : "펜이 있는 칸은 아직 글자가 없는 이 언어의 소리입니다. 누르면 그 글자가 만들어지고 그릴 수 있습니다.",
      "hp.ls.add.d" : "이곳에 글자를 추가합니다.",
      "hp.ls.sort" : "거르기와 정렬",
      "hp.ls.sort.d" : "칸을 걸러내거나 순서를 바꿉니다. 끌어서 옮기는 것은 내 순서에서, 아무것도 거르지 않았을 때만 됩니다.",
      "hp.ls.base" : "모든 언어가 처음부터 가진 글자 — a부터 z, !와 ?, 숫자 — 는 그릴 수 있지만 빼거나 이름을 바꿀 수는 없습니다.",
      "hp.l1.1" : "그리기",
      "hp.l1.1.d" : "위의 큰 글자를 누르고 그립니다.",
      "hp.l1.2" : "이름",
      "hp.l1.2.d" : "글자의 이름이자, 그 글자를 입력할 때 치는 것입니다.",
      "hp.l1.3" : "소리",
      "hp.l1.3.d" : "소리 줄을 누르고 소리표에서 글자를 어떻게 읽는지 고릅니다.",
      "hp.l1.4" : "메모",
      "hp.l1.4.d" : "글자에 대한 무엇이든: 뜻, 모양이 어디서 왔는지.",
      "hp.l1.borrow.d" : "그리는 대신 이미 있는 문자를 씁니다. 문자 종류를 고른 다음 문자를 고릅니다.",
      "hp.l1.svg.d" : "오른쪽 위의 공유 표시는 이 글자 하나만 SVG 그림으로 저장합니다.",
      "hp.gl.1" : "획을 긋습니다",
      "hp.gl.2" : "모양을 다듬습니다",
      "hp.gl.2.d" : "사각형 아래의 표시는 그린 것에 작용합니다. 각각이 하는 일은 아래에 있습니다.",
      "hp.gl.3.d" : "오른쪽 위의 저장을 누르세요. 폰트와 키보드의 글자가 바뀝니다.",
      "hp.ws.1" : "고릅니다",
      "hp.ws.1.d" : "줄을 누르면 체크 표시가 그리로 옮겨갑니다.",
      "hp.ws.2.d" : "오른쪽 위의 저장을 누르세요. 폰트와 키보드가 새 표기 방식을 따릅니다.",
      "hp.ab.p" : "아부기다에서는 자음이 모음을 기호로 달고 있습니다. 그 기호를 여기서 만듭니다.",
      "hp.ab.1" : "모음을 고릅니다",
      "hp.ab.1.d" : "맨 위의 줄에서.",
      "hp.ab.2.d" : "손가락으로 기호를 그립니다.",
      "hp.ab.3" : "위치를 정합니다",
      "hp.ab.3.d" : "화살표로 옮기고 크게 또는 작게 합니다. 아래에 그 기호를 단 자음이 모두 보여서 한 번에 확인할 수 있습니다.",
      "hp.bk.p" : "조합해서 쓰면 음절 하나가 한 칸입니다. 첫 자음, 모음, 끝 자음을 작게 그려 한데 모읍니다.",
      "hp.bk.1" : "모음 글자를 엽니다",
      "hp.bk.1.d" : "배치는 모음마다 그 글자의 페이지에서 고릅니다.",
      "hp.bk.2" : "나누는 방법을 고릅니다",
      "hp.bk.2.d" : "좌우는 모음을 자음 오른쪽에, 상하는 자음 아래에, 네 칸은 오른쪽 위에 놓습니다.",
      "hp.bk.3" : "받침",
      "hp.bk.3.d" : "좌우와 상하는 받침을 위해 아래에 한 줄을 더합니다. 네 칸은 받침을 아래 두 칸에 왼쪽부터 넣습니다. 네 글자보다 긴 음절은 조합하지 않습니다.",
      "hp.bk.p2" : "그림은 내 글자로 그려지므로, 자음과 모음을 먼저 그리세요.",
      "hp.sp.p" : "글자 사이가 얼마나 떨어지는지.",
      "hp.sp.1" : "밀어서 조절합니다",
      "hp.sp.1.d" : "왼쪽으로 갈수록 가까워지고, 0이면 붙습니다.",
      "hp.sp.2" : "확인합니다",
      "hp.sp.2.d" : "두 줄이 가로쓰기와 세로쓰기를 보여 줍니다.",
      "hp.sp.p2" : "게시물은 쓸 때의 간격을 그대로 가집니다.",
      "hp.sd.1" : "소리를 고릅니다",
      "hp.sd.1.d" : "글자를 읽는 소리 기호를 누릅니다. 다시 누르면 빠집니다.",
      "hp.sd.p" : "그룹 이름을 누르면 열리고 닫힙니다. 옆의 ?는 그 그룹이 무엇인지 알려 줍니다.",
      "hp.wd.p" : "이 언어의 모든 단어.",
      "hp.wd.add.d" : "아래의 +. 내 글자로 철자를 치고 뜻을 적은 뒤 저장합니다.",
      "hp.wd.open" : "단어를 누르면 그 페이지가 열립니다.",
      "hp.wd.find" : "위에서 검색하고, 품사로 거르고, 순서를 바꿉니다.",
      "hp.wd.gen.d" : "내 언어의 소리로 만든 단어들 중에서 고릅니다.",
      "hp.wd.sel.d" : "여러 단어를 표시한 다음 오른쪽 위에서 한꺼번에 삭제합니다.",
      "hp.w1.1.d" : "오른쪽 위의 펜을 누르면 단어를 고칠 수 있습니다.",
      "hp.w1.2" : "철자",
      "hp.w1.2.d" : "내 언어의 글자로 칩니다. 읽는 법은 글자를 따르며, 다르게 소리 나야 하면 읽기 페이지에서 바꿉니다.",
      "hp.w1.3" : "뜻과 예문",
      "hp.w1.3.d" : "제목 옆의 +를 누르면 추가됩니다.",
      "hp.w1.4" : "관련 단어",
      "hp.w1.4.d" : "동의어, 반의어, 그리고 이 단어가 만들어진 한 단어인 '유래어'. 이 단어에서 만들어진 단어도 함께 나옵니다.",
      "hp.w1.ety.d" : "관련어 칸에서 엽니다. 위에는 이 단어의 유래가, 아래에는 이 단어에서 만들어진 단어가 나옵니다.",
      "hp.w1.card.d" : "단어를 내 글자로 된 그림으로 만들어 공유합니다.",
      "hp.gn.p" : "이 언어에 있을 법한 단어를, 글자가 가진 소리로 만듭니다.",
      "hp.gn.1" : "음절 모양을 고릅니다",
      "hp.gn.1.d" : "첫 줄입니다. C는 자음, V는 모음이며 CV는 자음 다음 모음입니다. 아무것도 고르지 않으면 사전에 이미 있는 모양을 씁니다.",
      "hp.gn.2" : "살펴봅니다",
      "hp.gn.2.d" : "오른쪽 위의 버튼으로 새 목록을 만듭니다.",
      "hp.gn.3" : "하나를 가져옵니다",
      "hp.gn.3.d" : "단어를 누르면 새 단어 시트가 그 철자로 열립니다. 뜻을 적고 저장합니다.",
      "hp.gn.p2" : "내 글자로 쓸 수 있는 단어만 만들어집니다. 하나도 안 나오면 먼저 글자에 소리를 정하세요.",
      "hp.et.p" : "한 단어가 어디서 왔고 무엇이 거기서 나왔는지.",
      "hp.et.1" : "위",
      "hp.et.1.d" : "이 단어가 온 단어, 그 단어가 온 곳, 그렇게 처음까지.",
      "hp.et.2" : "아래",
      "hp.et.2.d" : "이 단어에서 만들어진 단어와, 거기서 또 만들어진 단어.",
      "hp.et.3" : "바꿉니다",
      "hp.et.3.d" : "단어 편집 페이지의 '유래어' 줄에서 이 단어가 온 단어를 고릅니다.",
      "hp.et.p2" : "단어를 누르면 열립니다. 누를 수 없는 줄은 삭제된 단어이며 철자만 남아 있습니다.",
      "hp.gr.p" : "문법은 한 권의 책입니다. 문장, 명사, 동사 등이 각각 한 장씩입니다.",
      "hp.gr.1" : "장을 엽니다",
      "hp.gr.1.d" : "그다음 그 안의 절을 엽니다.",
      "hp.gr.2" : "답합니다",
      "hp.gr.2.d" : "각 줄은 내 언어가 한 가지를 어떻게 하는지 묻습니다. 답을 고르거나 내 단어를 넣습니다.",
      "hp.gr.3" : "예문",
      "hp.gr.3.d" : "예문 옆의 +를 눌러 내 언어로 문장을 씁니다.",
      "hp.gr.p2" : "절 안에서는 그 절의 ?가 각 형태의 뜻을 예와 함께 알려 줍니다.",
      "hp.kb.ed" : "키보드 만들기",
      "hp.kb.1.d" : "+를 누르고 시작할 배열을 고릅니다.",
      "hp.kb.2" : "선택합니다",
      "hp.kb.2.d" : "키를 누르면 선택됩니다. 줄 번호나 열 글자를 누르면 그 줄이나 열 전체가 선택됩니다. 다시 누르면 풀립니다.",
      "hp.kb.3" : "키에 글자를 넣습니다",
      "hp.kb.3.d" : "키를 하나 또는 여러 개 선택합니다. ①②③은 고른 순서입니다. 키를 열어 같은 순서로 글자를 고르고 오른쪽 위에서 확정하면 ①, ②, ③에 차례로 들어갑니다.",
      "hp.kb.4.d" : "Lingua 키보드가 이 키보드로 입력하게 합니다.",
      "hp.kb.set.d" : "키를 선택한 상태에서 열어 글자를 고릅니다.",
      "hp.kb.join.d" : "키 두 개를 선택하면 하나로 합칩니다. 옆으로 붙은 것도, 위아래로 붙은 것도 됩니다.",
      "hp.kb.al" : "정렬",
      "hp.kb.al.d" : "줄을 선택하면 그 줄의 키를 왼쪽, 가운데, 오른쪽으로 모읍니다.",
      "hp.kb.add" : "추가",
      "hp.kb.add.d" : "줄을 선택하면 줄을 추가하고 위나 아래를 고릅니다. 열이면 왼쪽이나 오른쪽. 빈 칸을 선택하면 거기에 키를 넣습니다.",
      "hp.kb.cut.d" : "선택한 것을 뺍니다.",
      "hp.kb.undo" : "되돌리기와 다시 하기",
      "hp.kb.undo.d" : "변경을 하나씩 되돌리고, 다시 되살립니다.",
      "hp.kb.hold" : "키를 길게 눌러 끌면 옮겨집니다. 합친 키는 함께 움직입니다.",
      "hp.wk.p" : "이 언어의 페이지입니다. 어떤 언어인지, 어디서 쓰이는지, 글자, 그리고 내가 쓰는 모든 것.",
      "hp.wk.1" : "읽기",
      "hp.wk.1.d" : "제목을 누르면 그 부분이 열리고 닫힙니다.",
      "hp.wk.2" : "쓰기",
      "hp.wk.2.d" : "오른쪽 위의 펜. 개요를 채우고, 각 부분에 쓰고, 나만의 부분을 추가합니다.",
      "hp.wk.3.d" : "켜면 다른 사람이 페이지를 열어 읽을 수 있습니다.",
      "hp.wk.4.d" : "글자나 단어 같은 어떤 부분을 다른 사람이 페이지에서 내려받을 수 있는지.",
      "hp.ps.1" : "한 줄을 씁니다",
      "hp.ps.1.d" : "내 언어로. Lingua 키보드로 치면 내 글자로 나옵니다.",
      "hp.ps.2.d" : "그 줄의 뜻을 어떤 언어로든 씁니다. 스위치를 끄면 뜻 없이 올라갑니다.",
      "hp.ps.3" : "사진",
      "hp.ps.3.d" : "카메라나 보관함. 사진을 누르면 내 글자를 올리거나 자를 수 있습니다.",
      "hp.ps.4.d" : "마이크로 최대 30초까지 녹음합니다.",
      "hp.ps.5" : "보내기",
      "hp.ps.5.d" : "오른쪽 위의 종이비행기. 길게 누르면 모두 공개와 나만 보기가 바뀝니다. 자물쇠가 나만 보기입니다.",
      "hp.ps.dr.d" : "나중에 마저 쓰도록 보관합니다. 초안 목록은 여기서 열 수 있습니다.",
      "hp.spl.1" : "소리를 누릅니다",
      "hp.spl.1.d" : "누를 때마다 읽는 법 끝에 소리가 하나 붙고 재생됩니다.",
      "hp.spl.2.d" : "스피커로 단어 전체를 들을 수 있습니다.",
      "hp.rl.1" : "고릅니다",
      "hp.rl.1.d" : "단어를 누르면 연결되고, 다시 누르면 풀립니다.",
      "hp.rl.2" : "여기서 만듭니다",
      "hp.rl.2.d" : "단어가 아직 없으면 위에 철자와 뜻을 치고 +를 누르세요. 바로 만들어지고 연결됩니다.",
      "hp.rl.p" : "'유래어'는 단어 하나만 고르며, 이 단어에서 나온 단어는 목록에 나오지 않습니다.",
      "hp.nt.p" : "나를 위한 이 언어에 관한 메모.",
      "hp.nt.1.d" : "아래의 +.",
      "hp.nt.2" : "읽기와 고치기",
      "hp.nt.2.d" : "메모를 누르면 열리고, 오른쪽 위의 펜으로 고칩니다.",
      "hp.nt.3" : "삭제",
      "hp.nt.3.d" : "오른쪽 위의 선택을 누르고 메모를 표시해 삭제합니다."
    }
  };
})());
