...
defLang('es', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "wld.story.d"  : "Alguien de un libro, una película, un juego la habla.",
      "wld.people"   : "Un pueblo",
      "wld.people.d" : "Un pueblo que no está en esta tierra, o que estuvo.",
      "wld.place"    : "Un lugar",
      "wld.place.d"  : "Un valle, una isla, una ciudad, y cómo se habla allí.",
      "wld.real"     : "Para hablarla",
      "wld.real.d"   : "Hecha para usarla de verdad, con alguien o a solas.",
      "wld.play"     : "Para averiguar",
      "wld.play.d"   : "Hecha para ver qué pasa si una lengua funciona así.",
      ...
      "word.note"        : "Nota",
      "word.sp"          : "Esta letra aquí",
      "word.sp.none"     : "Pulse las letras",
      "word.sp.del"      : "Quitar esta letra",
