...
defLang('es', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.sns.2.m" : "Inventé una palabra para el olor a lluvia.",
      "ob.sns.3.n" : "Sela",
      "ob.sns.3.h" : "sela",
      "ob.sns.3.l" : "arun teva mi kastel, ova neri sa.",
      "ob.sns.3.m" : "Tres meses y ya escribo una frase entera.",
      "ob.sns.4.n" : "Kai",
      "ob.sns.4.h" : "kai",
      "ob.sns.4.l" : "mel korva anta ve losin.",
      "ob.sns.4.m" : "Mi teclado ya funciona en el móvil.",
      "ob.sns.5.n" : "Nuri",
      "ob.sns.5.h" : "nuri",
      "ob.sns.5.l" : "tavel esko rin, ilma korsa te.",
      "ob.sns.5.m" : "Sistema de numeración listo. Base doce.",
      "ob.sns.6.n" : "Erim",
      "ob.sns.6.h" : "erim",
      "ob.sns.6.l" : "vasta lome ker un sadi, terin ova.",
      "ob.sns.6.m" : "Seiscientas palabras. Ya suena a idioma.",
      "ob.tour.row.letters" : "Toca Letras.",
      "ob.tour.row.gram" : "Toca Gramática.",
      "ob.tour.letters" : "Tus letras.",
      "ob.tour.gram" : "Tu gramática.",
