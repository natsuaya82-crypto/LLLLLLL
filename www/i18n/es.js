...
defLang('es', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ab.d"             : "En una abugida una letra es una consonante con una marca vocálica encima, así que lo que tiene que quedar bien no es un dibujo sino cómo se asienta la marca sobre cada consonante. Cambie la marca aquí y cambian todas a la vez.",
      ...
      "lt.note"          : "Una letra y un sonido no son lo mismo. Un sonido puede escribirse de dos maneras, una letra puede leerse de dos maneras, y una letra puede existir antes de que decida qué dice.",
      ...
      "lt.use.d"         : "Qué letras escriben {0}. Un sonido puede tener más de una.",
      "lt.addsnd"        : "Qué lee",
      "lt.addsnd.d"      : "Póngale nombre a esta letra y diga qué sonidos lee. Puede no leer ninguno, o varios.",
      "lt.reads"         : "lee {0}",
      ...
      "word.syn.d"       : "Qué palabras significan lo mismo que {0}. Elegir una hace el par, en los dos sentidos.",
      ...
      "word.ant.d"       : "Qué palabras significan lo contrario de {0}. Elegir una hace el par, en los dos sentidos.",
      "word.ex"          : "Ejemplos",
      "word.ex.d"        : "Una frase en esta lengua y lo que significa. Escriba la frase con las palabras separadas por espacios; las que ya están en el diccionario se pueden oír.",
      "word.ex.ln.ph"    : "palabras separadas por espacios",
