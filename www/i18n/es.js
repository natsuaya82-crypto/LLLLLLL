...
defLang('es', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "word.note"        : "{0} sílabas. Arriba está la palabra misma, en los sonidos que elegiste.<br>Junto a cada sílaba va la lectura aproximada para hablantes de {1} ({2}); el botón la dice.",
      "word.note.1"      : "Una sílaba. Arriba está la palabra misma, en los sonidos que elegiste.<br>Junto a ella va la lectura aproximada para hablantes de {1} ({2}); el botón la dice.",
      "word.edit"        : "Cambiarla",
