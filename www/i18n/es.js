...
defLang('es', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "set.wipe"         : "Borrar los datos de este teléfono",
      "set.drop"         : "Eliminar cuenta",
      "set.drop.done"    : "Cuenta eliminada",
      "confirm.drop"     : "¿Eliminar tu cuenta? Tus publicaciones, fotos y grabaciones se van del servidor y no se pueden recuperar. La lengua de este teléfono se queda donde está.",
