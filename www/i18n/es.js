...
defLang('es', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "ob.sns.1.n" : "Mara",
      "ob.sns.1.h" : "mara",
      "ob.sns.1.l" : "Hoy terminé el alfabeto. Veintiocho letras.",
      "ob.sns.2.n" : "Tomás",
      "ob.sns.2.h" : "tomas",
      "ob.sns.2.l" : "Inventé una palabra para el olor a lluvia.",
      "ob.sns.3.n" : "Inés",
      "ob.sns.3.h" : "ines",
      "ob.sns.3.l" : "Tres meses y ya escribo una frase entera.",
      "ob.sns.4.n" : "Kai",
      "ob.sns.4.h" : "kai",
      "ob.sns.4.l" : "Mi teclado ya funciona en el móvil.",
      "ob.sns.5.n" : "Noor",
      "ob.sns.5.h" : "noor",
      "ob.sns.5.l" : "Sistema de numeración listo. Base doce.",
      "ob.sns.6.n" : "Elías",
      "ob.sns.6.h" : "elias",
      "ob.sns.6.l" : "Seiscientas palabras. Ya suena a idioma.",
      "ob.tour.row.letters" : "Toca Letras.",
      "ob.tour.row.words" : "Toca Léxico.",
      "ob.tour.row.gram" : "Toca Gramática.",
      "ob.tour.letters" : "Tus letras.",
      "ob.tour.words" : "Tus palabras.",
