...
defLang('es', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "mod.down"           : "Retirar esta publicación",
      "mod.up"             : "Restaurar",
      "mod.out"            : "Detener a @{0}",
      "mod.in"             : "Restablecer a @{0}",
      "mod.out.sure"       : "¿Detener esta cuenta? Conserva todo y puede leer, pero no podrá publicar, responder ni reaccionar hasta que lo deshagas.",
      "post.out"           : "Tu cuenta está detenida. Puedes leer, pero nada de lo que escribas se publicará.",
      "post.down"          : "Esta publicación fue retirada. Nadie más puede verla.",
