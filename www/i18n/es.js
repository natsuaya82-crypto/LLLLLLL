...
defLang('es', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "plan.pro.1"      : "Añadir letras, nombrarlas, borrarlas",
      "plan.pro.2"      : "Un silabario, un abyad, una abugida o una logografía",
      "plan.pro.3"      : "Hasta tres teclados que diseñas tú",
      "plan.price.free"  : "$0",
      "plan.pro.6"  : "Elegir los sonidos, las etapas de gramática y la dirección",
      "plan.pro.5"  : "Traer una lista como archivo y sacarla",
      "plan.pro.4"  : "Palabras sin límite",
      "plan.each.pro"  : "$8.33",
