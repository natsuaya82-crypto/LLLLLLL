...
defLang('es', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "confirm.wipe.langs": "¿Eliminar {0}? Se pierde todo lo creado en él: las palabras, las letras, el sistema de escritura, el teclado, las notas y los sonidos. También su copia de seguridad. Se elimina de tu cuenta, así que no volverá en otro teléfono. Tus otros idiomas, tus publicaciones y tu cuenta permanecen. Esto no se puede deshacer.",
      "langs.title"      : "Idiomas",
