...
defLang('es', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "snd.empty" : "Aún no hay sonidos",
      "snd.nolt" : "ninguna letra lo dice",
      ...
      "fmr.what"         : "Escribe una vez cómo se hace una forma y cualquier palabra podrá dar las formas que aún no tiene. Nada se crea hasta que lo pidas, y lo que sale es una palabra normal: edítala, bórrala, o escribe tú mismo una irregular.",
      ...
      "confirm.wipe"     : "¿Borrar todo lo que hay en este teléfono y cerrar sesión? El idioma, las letras y los ajustes desaparecen, y no se puede deshacer.",
      "langs.title"      : "Idiomas",
      ...
      "plan.plus.2"      : "Un silabario, un abyad, una abugida o una logografía",
      "plan.plus.3"      : "Hasta tres teclados que diseñas tú",
      "plan.studio.1"    : "Todo lo de Plus",
      "plan.studio.2"    : "Trabajar con una IA: palabra a partir de un significado, gramática, ejemplos",
      "plan.studio.3"    : "Sugerencias sin límite diario",
      "plan.price.free"  : "$0",
      "plan.plus.6"  : "Elegir los sonidos, las etapas de gramática y la dirección",
      "plan.plus.5"  : "Traer una lista como archivo y sacarla",
      "plan.plus.4"  : "Palabras sin límite",
      "plan.each.studio"  : "$16.67",
      "plan.each.plus"  : "$8.33",
      "plan.price.studio.yr"  : "$199.99",
      "plan.price.plus.yr"  : "$99.99",
      "plan.each"  : "{0} al mes, facturado una vez al año",
      "plan.per.yr"  : "/ año",
      "plan.per.mo"  : "/ mes",
      "plan.save"  : "2 meses gratis",
      "plan.term.yr"  : "Anual",
      "plan.term.mo"  : "Mensual",
