...
defLang('es', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "kb.kb.add"               : "Añadir un teclado",
      "kb.kb.del"               : "Eliminar este teclado",
      "kb.del.ask"               : "¿Eliminar este teclado para siempre? Los demás no se verán afectados.",
      "kb.del.done"               : "Teclado eliminado",
      ...
      "sns.lock.h"      : "Inicia sesión para ver la línea de tiempo",
      "sns.lock.cta"    : "Iniciar sesión",
      "tab.find"         : "Buscar",
      "tab.home"         : "Inicio",
