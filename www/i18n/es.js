...
defLang('es', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "cap.hid"                   : "Hay {0} palabras más aquí, y en tu copia de seguridad",
      "cap.lapse.h"               : "Tu plan ha terminado",
      "cap.lapse.d"               : "Lingua vuelve a Gratis, así que el diccionario muestra las primeras 100 palabras y la escritura vuelve a ser un alfabeto. <b>No se ha borrado nada.</b> Todas tus palabras, tus letras y tu teclado siguen aquí y siguen en tu copia de seguridad, y todo vuelve en cuanto te suscribas de nuevo.",
      "cap.lapse.ok"              : "Entendido",
      ...
      "dir.ttb-rl"    : "Hacia abajo, columnas de derecha a izquierda",
      "dir.ttb-lr"    : "Hacia abajo, columnas de izquierda a derecha",
      "dir.locked"    : "Elegir en qué dirección se escribe tu lengua",
      "lt.name"          : "Nombre",
      "lt.name.ph"       : "p. ej. esh",
