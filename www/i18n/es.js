...
defLang('es', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "confirm.wipe.langs": "¿Borrar los datos de este teléfono? Se van todos los idiomas que hay en él: las palabras, las letras, el sistema de escritura, el teclado y las notas. Tu cuenta se queda, y también tus publicaciones y tus ajustes. Las copias de seguridad se quedan. Nada de este teléfono se puede recuperar.",
      "langs.title"      : "Idiomas",
