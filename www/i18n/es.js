...
defLang('es', (function(){
  ...
  return {
    ...
    str    : {
      ...
      "wr.out.ok"        : "Guardada",
      "wr.say.build"     : "Hoja creada — {0} bytes",
      "wr.say.build.no"  : "Hoja no creada — los nombres no caben en la banda",
      "wr.say.b64"       : "Codificada — {0} caracteres",
      "wr.say.b64.no"    : "La codificación falló — {0}",
      "wr.say.nobridge"  : "No hay dónde guardarla",
      "wr.say.sent"      : "Entregada al teléfono",
      "wr.say.filed"     : "Guardada como {0}",
      "wr.say.have"      : "En Sheets — {0} archivos, el más nuevo {1}",
      "wr.say.have.none" : "En Sheets — no hay nada",
      "wr.say.have.no"   : "No se pudo mirar en Sheets — {0}",
      "wr.say.unnamed"   : "El teléfono respondió sin nombre de archivo",
      "wr.say.refused"   : "El teléfono la rechazó — {0}",
      "wr.say.got"       : "Archivo — {0} bytes",
      "wr.say.kind"      : "Contenido — {0}",
      "wr.say.jpeg"      : "Foto dentro — {0} bytes",
      "wr.say.jpeg.no"   : "No hay foto dentro",
      "wr.say.draw"      : "Se pidió al teléfono dibujar la página",
      "wr.say.drew"      : "El teléfono la dibujó — {0} caracteres",
      "wr.say.drew.no"   : "El teléfono no dibujó nada",
      "wr.say.read"      : "Leído — {0} nombres, {1} con tinta",
