...
/* Posts, not your own language -- that search is in the build tab, on the
   ...
   検索は別物ね」 */
function vExplore(){ return snsEmpty('tab.find'); }
/* Who read you, who answered, who followed. */
function vNotif(){ return snsEmpty('tab.notif'); }
