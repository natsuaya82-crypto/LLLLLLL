...
export function halfDone(){
  ...
  return [
    ...
    /* 畳んだ投稿。「もっと読むで開くTwitterと同じ方式で頼む。」 OWNER
       2026-09-15、**五行**「5で」OWNER 2026-09-16。

       高さを選ぶ間だけ 3・5・8 の三つの顔があり、それぞれが `POST_FOLD` を
       書き換えていました。**決まったので消しました** ── アプリが取れない値で
       画面を歩かせると、検査も写真も「在り得ない状態」についての物になります。
       今はアプリそのままの高さです。
    ...
    ['a long post folded', () => {
        ...
        POSTS.unshift({ id:'fold-1', at: Date.now()-120000, lang: langId,
