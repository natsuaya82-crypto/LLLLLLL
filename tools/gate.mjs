...
const FAST = ['assets-check', 'docs-check', 'es5-check', 'grammar-engine-check', 'dead-check', 'import-check', 'sides-check',
              ...
              'token-check', 'verify-check', 'push-check', 'store-localize', 'writes-check', 'hand-check'];
...
const SLOW = ['migrate-check', 'i18n-check', 'act-check', 'conv-check', 'card-check',
              'word-check', 'gen-check', 'forms-check', 'post-check', 'fill-check', 'round-check', 'guide-check', 'block-check',
              'base-check', 'kb-check', 'plan-check', 'term-check', 'sheet-check',
              'shape-check', 'draft-check', 'gramlang-check', 'world-check', 'tl-check', 'scroll-check',
