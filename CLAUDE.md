...
`press` prints `buttons pressed: 6064` for the same reason — and it is what a
...
render of the feed plus the two faces of it the fixture holds, and to 6064
when a photograph became a thing you press and the fixture grew a post
carrying four of them. A number
